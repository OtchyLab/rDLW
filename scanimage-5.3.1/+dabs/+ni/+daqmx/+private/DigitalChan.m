classdef DigitalChan < dabs.ni.daqmx.Channel
   ...
   %% CONSTRUCTOR/DESTRUCTOR
    ...
    %% ABSTRACT METHOD IMPLEMENTATIONS (dabs.ni.daqmx.Channel)
    methods (Hidden)
        ...
        function postCreationListener(obj)
            ...
            if length(taskChannelTypes) > 1
                delete(obj(1).task);
                most.idioms.dispError(['The Matlab DAQmx package does not, at this time, allow Digital I/O Tasks\n' ...
