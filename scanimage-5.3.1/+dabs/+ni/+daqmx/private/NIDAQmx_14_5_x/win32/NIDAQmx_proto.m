...
%This function was generated by loadlibrary.m parser version  on Thu Apr 23 12:52:18 2015
...
fcns.name{fcnNum}='DAQmxCreateAIRosetteStrainGageChan'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'cstring', 'double', 'double', 'long', 'double', 'longPtr', 'ulong', 'long', 'long', 'double', 'double', 'double', 'double', 'double'};fcnNum=fcnNum+1;
...
fcns.name{fcnNum}='DAQmxCreateAIVelocityIEPEChan'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'cstring', 'long', 'double', 'double', 'long', 'double', 'long', 'long', 'double', 'cstring'};fcnNum=fcnNum+1;
...
% int32 __stdcall DAQmxCreateCIDutyCycleChan ( TaskHandle taskHandle , const char counter [], const char nameToAssignToChannel [], float64 minFreq , float64 maxFreq , int32 edge , const char customScaleName []); 
fcns.name{fcnNum}='DAQmxCreateCIDutyCycleChan'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'cstring', 'double', 'double', 'long', 'cstring'};fcnNum=fcnNum+1;
...
% int32 __stdcall DAQmxReadCounterF64Ex ( TaskHandle taskHandle , int32 numSampsPerChan , float64 timeout , bool32 fillMode , float64 readArray [], uInt32 arraySizeInSamps , int32 * sampsPerChanRead , bool32 * reserved ); 
fcns.name{fcnNum}='DAQmxReadCounterF64Ex'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'long', 'double', 'ulong', 'doublePtr', 'ulong', 'longPtr', 'ulongPtr'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxReadCounterU32Ex ( TaskHandle taskHandle , int32 numSampsPerChan , float64 timeout , bool32 fillMode , uInt32 readArray [], uInt32 arraySizeInSamps , int32 * sampsPerChanRead , bool32 * reserved ); 
fcns.name{fcnNum}='DAQmxReadCounterU32Ex'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'long', 'double', 'ulong', 'ulongPtr', 'ulong', 'longPtr', 'ulongPtr'};fcnNum=fcnNum+1;
...
fcns.name{fcnNum}='DAQmxCreateWatchdogTimerTaskEx'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'cstring', 'cstring', 'ulongPtr', 'double'};fcnNum=fcnNum+1;
...
fcns.name{fcnNum}='DAQmxCfgWatchdogAOExpirStates'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'doublePtr', 'longPtr', 'ulong'};fcnNum=fcnNum+1;
...
fcns.name{fcnNum}='DAQmxCfgWatchdogCOExpirStates'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'longPtr', 'ulong'};fcnNum=fcnNum+1;
...
fcns.name{fcnNum}='DAQmxCfgWatchdogDOExpirStates'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'longPtr', 'ulong'};fcnNum=fcnNum+1;
...
fcns.name{fcnNum}='DAQmxDSASetCalTemp'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'double'};fcnNum=fcnNum+1;
...
fcns.name{fcnNum}='DAQmxAdjust4610Cal'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'double', 'double'};fcnNum=fcnNum+1;
...
% int32 __stdcall DAQmxAdjustDSAAOTimebaseCal ( CalHandle calHandle , float64 measuredFrequency , bool32 * calComplete ); 
fcns.name{fcnNum}='DAQmxAdjustDSAAOTimebaseCal'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'double', 'ulongPtr'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxSetupDSAAOTimebaseCal ( CalHandle calHandle , float64 * expectedFrequency ); 
fcns.name{fcnNum}='DAQmxSetupDSAAOTimebaseCal'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'doublePtr'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxGet4463AdjustPoints ( CalHandle calHandle , int32 terminalConfig , float64 gain , float64 * adjustmentPoints , uInt32 bufferSize ); 
fcns.name{fcnNum}='DAQmxGet4463AdjustPoints'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'long', 'double', 'doublePtr', 'ulong'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxAdjust4463Cal ( CalHandle calHandle , const char channelNames [], float64 referenceVoltage ); 
fcns.name{fcnNum}='DAQmxAdjust4463Cal'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'double'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxSetup4463Cal ( CalHandle calHandle , const char channelNames [], int32 terminalConfig , float64 gain , float64 outputVoltage ); 
fcns.name{fcnNum}='DAQmxSetup4463Cal'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'long', 'double', 'double'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxAdjustTIOTimebaseCal ( CalHandle calHandle , float64 referenceFrequency ); 
fcns.name{fcnNum}='DAQmxAdjustTIOTimebaseCal'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'double'};fcnNum=fcnNum+1;
...
% int32 __stdcall DAQmxSetup4339Cal ( CalHandle calHandle , const char channelNames [], int32 calMode , float64 rangeMax , float64 rangeMin , float64 excitationVoltage ); 
fcns.name{fcnNum}='DAQmxSetup4339Cal'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'long', 'double', 'double', 'double'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxAdjust4339Cal ( CalHandle calHandle , float64 refVoltage ); 
fcns.name{fcnNum}='DAQmxAdjust4339Cal'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'double'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxGet4339CalAdjustPoints ( CalHandle calHandle , float64 * adjustmentPoints , uInt32 bufferSize ); 
fcns.name{fcnNum}='DAQmxGet4339CalAdjustPoints'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'doublePtr', 'ulong'};fcnNum=fcnNum+1;
...
fcns.name{fcnNum}='DAQmxAdjust4357Cal'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'doublePtr', 'long'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxSetup4322Cal ( CalHandle calHandle , const char channelNames [], int32 outputType , float64 outputVal ); 
fcns.name{fcnNum}='DAQmxSetup4322Cal'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'long', 'double'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxAdjust4322Cal ( CalHandle calHandle , const char channelNames [], float64 refVal ); 
fcns.name{fcnNum}='DAQmxAdjust4322Cal'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'double'};fcnNum=fcnNum+1;
...
fcns.name{fcnNum}='DAQmxGet4322CalAdjustPoints'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'long', 'doublePtr', 'ulong'};fcnNum=fcnNum+1;
...
% int32 __stdcall DAQmxGet9209CalAdjustPoints ( CalHandle calHandle , float64 * adjustmentPoints , uInt32 bufferSize ); 
fcns.name{fcnNum}='DAQmxGet9209CalAdjustPoints'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'doublePtr', 'ulong'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxAdjust9209GainCal ( CalHandle calHandle , const char channelNames [], int32 terminalConfig , float64 value ); 
fcns.name{fcnNum}='DAQmxAdjust9209GainCal'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'long', 'double'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxAdjust9209OffsetCal ( CalHandle calHandle , const char channelNames []); 
fcns.name{fcnNum}='DAQmxAdjust9209OffsetCal'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring'};fcnNum=fcnNum+1;
...
% int32 __stdcall DAQmxGet9212CalAdjustPoints ( CalHandle calHandle , const char channelNames [], float64 * adjustmentPoints , uInt32 bufferSize ); 
fcns.name{fcnNum}='DAQmxGet9212CalAdjustPoints'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'doublePtr', 'ulong'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxAdjust9212Cal ( CalHandle calHandle , const char channelNames [], float64 value ); 
fcns.name{fcnNum}='DAQmxAdjust9212Cal'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'double'};fcnNum=fcnNum+1;
...
% int32 __stdcall DAQmxGet9216CalAdjustPoints ( CalHandle calHandle , float64 * adjustmentPoints , uInt32 bufferSize ); 
fcns.name{fcnNum}='DAQmxGet9216CalAdjustPoints'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'doublePtr', 'ulong'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxAdjust9216Cal ( CalHandle calHandle , const char channelNames [], float64 value ); 
fcns.name{fcnNum}='DAQmxAdjust9216Cal'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'double'};fcnNum=fcnNum+1;
...
% int32 __stdcall DAQmxSetup9218Cal ( CalHandle calHandle , const char channelNames [], float64 rangeMin , float64 rangeMax , int32 measType ); 
fcns.name{fcnNum}='DAQmxSetup9218Cal'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'double', 'double', 'long'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxGet9218CalAdjustPoints ( CalHandle calHandle , float64 * adjustmentPoints , uInt32 bufferSize ); 
fcns.name{fcnNum}='DAQmxGet9218CalAdjustPoints'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'doublePtr', 'ulong'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxAdjust9218Cal ( CalHandle calHandle , const char channelNames [], float64 value ); 
fcns.name{fcnNum}='DAQmxAdjust9218Cal'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'double'};fcnNum=fcnNum+1;
...
fcns.name{fcnNum}='DAQmxGet9220CalAdjustPoints'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'doublePtr', 'ulong'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxAdjust9220Cal ( CalHandle calHandle , const char channelNames [], float64 value ); 
fcns.name{fcnNum}='DAQmxAdjust9220Cal'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'double'};fcnNum=fcnNum+1;
...
% int32 __stdcall DAQmxGet9226CalAdjustPoints ( CalHandle calHandle , float64 * adjustmentPoints , uInt32 bufferSize ); 
fcns.name{fcnNum}='DAQmxGet9226CalAdjustPoints'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'doublePtr', 'ulong'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxAdjust9226Cal ( CalHandle calHandle , const char channelNames [], float64 value ); 
fcns.name{fcnNum}='DAQmxAdjust9226Cal'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'double'};fcnNum=fcnNum+1;
...
fcns.name{fcnNum}='DAQmxGet9229CalAdjustPoints'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'doublePtr', 'ulong'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxAdjust9229Cal ( CalHandle calHandle , const char channelNames [], float64 value ); 
fcns.name{fcnNum}='DAQmxAdjust9229Cal'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'double'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxGet9230CalAdjustPoints ( CalHandle calHandle , float64 * adjustmentPoints , uInt32 bufferSize ); 
fcns.name{fcnNum}='DAQmxGet9230CalAdjustPoints'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'doublePtr', 'ulong'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxAdjust9230Cal ( CalHandle calHandle , const char channelNames [], float64 value ); 
fcns.name{fcnNum}='DAQmxAdjust9230Cal'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'double'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxGet9232CalAdjustPoints ( CalHandle calHandle , float64 * adjustmentPoints , uInt32 bufferSize ); 
fcns.name{fcnNum}='DAQmxGet9232CalAdjustPoints'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'doublePtr', 'ulong'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxAdjust9232Cal ( CalHandle calHandle , const char channelNames [], float64 value ); 
fcns.name{fcnNum}='DAQmxAdjust9232Cal'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'double'};fcnNum=fcnNum+1;
...
% int32 __stdcall DAQmxGet9238CalAdjustPoints ( CalHandle calHandle , float64 * adjustmentPoints , uInt32 bufferSize ); 
fcns.name{fcnNum}='DAQmxGet9238CalAdjustPoints'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'doublePtr', 'ulong'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxAdjust9238Cal ( CalHandle calHandle , const char channelNames [], float64 value ); 
fcns.name{fcnNum}='DAQmxAdjust9238Cal'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'double'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxGet9239CalAdjustPoints ( CalHandle calHandle , float64 * adjustmentPoints , uInt32 bufferSize ); 
fcns.name{fcnNum}='DAQmxGet9239CalAdjustPoints'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'doublePtr', 'ulong'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxAdjust9239Cal ( CalHandle calHandle , const char channelNames [], float64 value ); 
fcns.name{fcnNum}='DAQmxAdjust9239Cal'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'double'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxGet9242CalAdjustPoints ( CalHandle calHandle , float64 * adjustmentPoints , uInt32 bufferSize ); 
fcns.name{fcnNum}='DAQmxGet9242CalAdjustPoints'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'doublePtr', 'ulong'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxSetup9242Cal ( CalHandle calHandle , const char channelNames [], float64 value ); 
fcns.name{fcnNum}='DAQmxSetup9242Cal'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'double'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxAdjust9242Cal ( CalHandle calHandle , const char channelNames [], float64 value ); 
fcns.name{fcnNum}='DAQmxAdjust9242Cal'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'double'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxGet9244CalAdjustPoints ( CalHandle calHandle , float64 * adjustmentPoints , uInt32 bufferSize ); 
fcns.name{fcnNum}='DAQmxGet9244CalAdjustPoints'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'doublePtr', 'ulong'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxSetup9244Cal ( CalHandle calHandle , const char channelNames [], float64 value ); 
fcns.name{fcnNum}='DAQmxSetup9244Cal'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'double'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxAdjust9244Cal ( CalHandle calHandle , const char channelNames [], float64 value ); 
fcns.name{fcnNum}='DAQmxAdjust9244Cal'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'double'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxGet9246CalAdjustPoints ( CalHandle calHandle , float64 * adjustmentPoints , uInt32 bufferSize ); 
fcns.name{fcnNum}='DAQmxGet9246CalAdjustPoints'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'doublePtr', 'ulong'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxAdjust9246GainCal ( CalHandle calHandle , const char channelNames [], float64 value ); 
fcns.name{fcnNum}='DAQmxAdjust9246GainCal'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'double'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxAdjust9246OffsetCal ( CalHandle calHandle , const char channelNames []); 
fcns.name{fcnNum}='DAQmxAdjust9246OffsetCal'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxGet9247CalAdjustPoints ( CalHandle calHandle , float64 * adjustmentPoints , uInt32 bufferSize ); 
fcns.name{fcnNum}='DAQmxGet9247CalAdjustPoints'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'doublePtr', 'ulong'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxAdjust9247GainCal ( CalHandle calHandle , const char channelNames [], float64 value ); 
fcns.name{fcnNum}='DAQmxAdjust9247GainCal'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'double'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxAdjust9247OffsetCal ( CalHandle calHandle , const char channelNames []); 
fcns.name{fcnNum}='DAQmxAdjust9247OffsetCal'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring'};fcnNum=fcnNum+1;
...
fcns.name{fcnNum}='DAQmxSetAnalogPowerUpStatesWithOutputType'; fcns.calltype{fcnNum}='cdecl'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'cstring', 'doublePtr', 'longPtr', 'ulong'};fcnNum=fcnNum+1;
...
fcns.name{fcnNum}='DAQmxGetAnalogPowerUpStatesWithOutputType'; fcns.calltype{fcnNum}='cdecl'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'cstring', 'doublePtr', 'longPtr', 'ulongPtr'};fcnNum=fcnNum+1;
...
fcns.name{fcnNum}='DAQmxAutoConfigureCDAQSyncConnections'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'cstring', 'double'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxGetAutoConfiguredCDAQSyncConnections ( char portList [], uInt32 portListSize ); 
fcns.name{fcnNum}='DAQmxGetAutoConfiguredCDAQSyncConnections'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'cstring', 'ulong'};fcnNum=fcnNum+1;
...
fcns.name{fcnNum}='DAQmxAreConfiguredCDAQSyncPortsDisconnected'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'cstring', 'double', 'ulongPtr'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxGetDisconnectedCDAQSyncPorts ( char portList [], uInt32 portListSize ); 
fcns.name{fcnNum}='DAQmxGetDisconnectedCDAQSyncPorts'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'cstring', 'ulong'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxAddCDAQSyncConnection ( const char portList []); 
fcns.name{fcnNum}='DAQmxAddCDAQSyncConnection'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'cstring'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxRemoveCDAQSyncConnection ( const char portList []); 
fcns.name{fcnNum}='DAQmxRemoveCDAQSyncConnection'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'cstring'};fcnNum=fcnNum+1;
...
fcns.name{fcnNum}='DAQmxGetAIStrainGageForceReadFromChan'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'ulongPtr'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxSetAIStrainGageForceReadFromChan ( TaskHandle taskHandle , const char channel [], bool32 data ); 
fcns.name{fcnNum}='DAQmxSetAIStrainGageForceReadFromChan'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'ulong'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxResetAIStrainGageForceReadFromChan ( TaskHandle taskHandle , const char channel []); 
fcns.name{fcnNum}='DAQmxResetAIStrainGageForceReadFromChan'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring'};fcnNum=fcnNum+1;
...
fcns.name{fcnNum}='DAQmxGetAIRosetteStrainGageRosetteType'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'longPtr'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxGetAIRosetteStrainGageOrientation ( TaskHandle taskHandle , const char channel [], float64 * data ); 
fcns.name{fcnNum}='DAQmxGetAIRosetteStrainGageOrientation'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'doublePtr'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxSetAIRosetteStrainGageOrientation ( TaskHandle taskHandle , const char channel [], float64 data ); 
fcns.name{fcnNum}='DAQmxSetAIRosetteStrainGageOrientation'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'double'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxResetAIRosetteStrainGageOrientation ( TaskHandle taskHandle , const char channel []); 
fcns.name{fcnNum}='DAQmxResetAIRosetteStrainGageOrientation'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring'};fcnNum=fcnNum+1;
...
fcns.name{fcnNum}='DAQmxGetAIRosetteStrainGageStrainChans'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'cstring', 'ulong'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxGetAIRosetteStrainGageRosetteMeasType ( TaskHandle taskHandle , const char channel [], int32 * data ); 
fcns.name{fcnNum}='DAQmxGetAIRosetteStrainGageRosetteMeasType'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'longPtr'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxSetAIRosetteStrainGageRosetteMeasType ( TaskHandle taskHandle , const char channel [], int32 data ); 
fcns.name{fcnNum}='DAQmxSetAIRosetteStrainGageRosetteMeasType'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'long'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxResetAIRosetteStrainGageRosetteMeasType ( TaskHandle taskHandle , const char channel []); 
fcns.name{fcnNum}='DAQmxResetAIRosetteStrainGageRosetteMeasType'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring'};fcnNum=fcnNum+1;
...
fcns.name{fcnNum}='DAQmxGetAIVelocityUnits'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'longPtr'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxSetAIVelocityUnits ( TaskHandle taskHandle , const char channel [], int32 data ); 
fcns.name{fcnNum}='DAQmxSetAIVelocityUnits'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'long'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxResetAIVelocityUnits ( TaskHandle taskHandle , const char channel []); 
fcns.name{fcnNum}='DAQmxResetAIVelocityUnits'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxGetAIVelocityIEPESensordBRef ( TaskHandle taskHandle , const char channel [], float64 * data ); 
fcns.name{fcnNum}='DAQmxGetAIVelocityIEPESensordBRef'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'doublePtr'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxSetAIVelocityIEPESensordBRef ( TaskHandle taskHandle , const char channel [], float64 data ); 
fcns.name{fcnNum}='DAQmxSetAIVelocityIEPESensordBRef'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'double'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxResetAIVelocityIEPESensordBRef ( TaskHandle taskHandle , const char channel []); 
fcns.name{fcnNum}='DAQmxResetAIVelocityIEPESensordBRef'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxGetAIVelocityIEPESensorSensitivity ( TaskHandle taskHandle , const char channel [], float64 * data ); 
fcns.name{fcnNum}='DAQmxGetAIVelocityIEPESensorSensitivity'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'doublePtr'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxSetAIVelocityIEPESensorSensitivity ( TaskHandle taskHandle , const char channel [], float64 data ); 
fcns.name{fcnNum}='DAQmxSetAIVelocityIEPESensorSensitivity'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'double'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxResetAIVelocityIEPESensorSensitivity ( TaskHandle taskHandle , const char channel []); 
fcns.name{fcnNum}='DAQmxResetAIVelocityIEPESensorSensitivity'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxGetAIVelocityIEPESensorSensitivityUnits ( TaskHandle taskHandle , const char channel [], int32 * data ); 
fcns.name{fcnNum}='DAQmxGetAIVelocityIEPESensorSensitivityUnits'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'longPtr'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxSetAIVelocityIEPESensorSensitivityUnits ( TaskHandle taskHandle , const char channel [], int32 data ); 
fcns.name{fcnNum}='DAQmxSetAIVelocityIEPESensorSensitivityUnits'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'long'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxResetAIVelocityIEPESensorSensitivityUnits ( TaskHandle taskHandle , const char channel []); 
fcns.name{fcnNum}='DAQmxResetAIVelocityIEPESensorSensitivityUnits'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring'};fcnNum=fcnNum+1;
...
% int32 __stdcall DAQmxGetAIBridgeShuntCalShuntCalASrc ( TaskHandle taskHandle , const char channel [], int32 * data ); 
fcns.name{fcnNum}='DAQmxGetAIBridgeShuntCalShuntCalASrc'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'longPtr'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxSetAIBridgeShuntCalShuntCalASrc ( TaskHandle taskHandle , const char channel [], int32 data ); 
fcns.name{fcnNum}='DAQmxSetAIBridgeShuntCalShuntCalASrc'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'long'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxResetAIBridgeShuntCalShuntCalASrc ( TaskHandle taskHandle , const char channel []); 
fcns.name{fcnNum}='DAQmxResetAIBridgeShuntCalShuntCalASrc'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring'};fcnNum=fcnNum+1;
...
% int32 __stdcall DAQmxGetAIBridgeShuntCalShuntCalBResistance ( TaskHandle taskHandle , const char channel [], float64 * data ); 
fcns.name{fcnNum}='DAQmxGetAIBridgeShuntCalShuntCalBResistance'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'doublePtr'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxSetAIBridgeShuntCalShuntCalBResistance ( TaskHandle taskHandle , const char channel [], float64 data ); 
fcns.name{fcnNum}='DAQmxSetAIBridgeShuntCalShuntCalBResistance'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'double'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxResetAIBridgeShuntCalShuntCalBResistance ( TaskHandle taskHandle , const char channel []); 
fcns.name{fcnNum}='DAQmxResetAIBridgeShuntCalShuntCalBResistance'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxGetAIBridgeShuntCalShuntCalBActualResistance ( TaskHandle taskHandle , const char channel [], float64 * data ); 
fcns.name{fcnNum}='DAQmxGetAIBridgeShuntCalShuntCalBActualResistance'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'doublePtr'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxSetAIBridgeShuntCalShuntCalBActualResistance ( TaskHandle taskHandle , const char channel [], float64 data ); 
fcns.name{fcnNum}='DAQmxSetAIBridgeShuntCalShuntCalBActualResistance'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'double'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxResetAIBridgeShuntCalShuntCalBActualResistance ( TaskHandle taskHandle , const char channel []); 
fcns.name{fcnNum}='DAQmxResetAIBridgeShuntCalShuntCalBActualResistance'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring'};fcnNum=fcnNum+1;
...
% int32 __stdcall DAQmxGetAIExcitIdleOutputBehavior ( TaskHandle taskHandle , const char channel [], int32 * data ); 
fcns.name{fcnNum}='DAQmxGetAIExcitIdleOutputBehavior'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'longPtr'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxSetAIExcitIdleOutputBehavior ( TaskHandle taskHandle , const char channel [], int32 data ); 
fcns.name{fcnNum}='DAQmxSetAIExcitIdleOutputBehavior'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'long'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxResetAIExcitIdleOutputBehavior ( TaskHandle taskHandle , const char channel []); 
fcns.name{fcnNum}='DAQmxResetAIExcitIdleOutputBehavior'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring'};fcnNum=fcnNum+1;
...
% int32 __stdcall DAQmxGetAIDigFltrEnable ( TaskHandle taskHandle , const char channel [], bool32 * data ); 
fcns.name{fcnNum}='DAQmxGetAIDigFltrEnable'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'ulongPtr'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxSetAIDigFltrEnable ( TaskHandle taskHandle , const char channel [], bool32 data ); 
fcns.name{fcnNum}='DAQmxSetAIDigFltrEnable'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'ulong'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxResetAIDigFltrEnable ( TaskHandle taskHandle , const char channel []); 
fcns.name{fcnNum}='DAQmxResetAIDigFltrEnable'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxGetAIDigFltrType ( TaskHandle taskHandle , const char channel [], int32 * data ); 
fcns.name{fcnNum}='DAQmxGetAIDigFltrType'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'longPtr'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxSetAIDigFltrType ( TaskHandle taskHandle , const char channel [], int32 data ); 
fcns.name{fcnNum}='DAQmxSetAIDigFltrType'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'long'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxResetAIDigFltrType ( TaskHandle taskHandle , const char channel []); 
fcns.name{fcnNum}='DAQmxResetAIDigFltrType'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxGetAIDigFltrResponse ( TaskHandle taskHandle , const char channel [], int32 * data ); 
fcns.name{fcnNum}='DAQmxGetAIDigFltrResponse'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'longPtr'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxSetAIDigFltrResponse ( TaskHandle taskHandle , const char channel [], int32 data ); 
fcns.name{fcnNum}='DAQmxSetAIDigFltrResponse'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'long'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxResetAIDigFltrResponse ( TaskHandle taskHandle , const char channel []); 
fcns.name{fcnNum}='DAQmxResetAIDigFltrResponse'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxGetAIDigFltrOrder ( TaskHandle taskHandle , const char channel [], uInt32 * data ); 
fcns.name{fcnNum}='DAQmxGetAIDigFltrOrder'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'ulongPtr'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxSetAIDigFltrOrder ( TaskHandle taskHandle , const char channel [], uInt32 data ); 
fcns.name{fcnNum}='DAQmxSetAIDigFltrOrder'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'ulong'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxResetAIDigFltrOrder ( TaskHandle taskHandle , const char channel []); 
fcns.name{fcnNum}='DAQmxResetAIDigFltrOrder'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxGetAIDigFltrLowpassCutoffFreq ( TaskHandle taskHandle , const char channel [], float64 * data ); 
fcns.name{fcnNum}='DAQmxGetAIDigFltrLowpassCutoffFreq'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'doublePtr'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxSetAIDigFltrLowpassCutoffFreq ( TaskHandle taskHandle , const char channel [], float64 data ); 
fcns.name{fcnNum}='DAQmxSetAIDigFltrLowpassCutoffFreq'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'double'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxResetAIDigFltrLowpassCutoffFreq ( TaskHandle taskHandle , const char channel []); 
fcns.name{fcnNum}='DAQmxResetAIDigFltrLowpassCutoffFreq'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxGetAIDigFltrHighpassCutoffFreq ( TaskHandle taskHandle , const char channel [], float64 * data ); 
fcns.name{fcnNum}='DAQmxGetAIDigFltrHighpassCutoffFreq'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'doublePtr'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxSetAIDigFltrHighpassCutoffFreq ( TaskHandle taskHandle , const char channel [], float64 data ); 
fcns.name{fcnNum}='DAQmxSetAIDigFltrHighpassCutoffFreq'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'double'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxResetAIDigFltrHighpassCutoffFreq ( TaskHandle taskHandle , const char channel []); 
fcns.name{fcnNum}='DAQmxResetAIDigFltrHighpassCutoffFreq'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxGetAIDigFltrBandpassCenterFreq ( TaskHandle taskHandle , const char channel [], float64 * data ); 
fcns.name{fcnNum}='DAQmxGetAIDigFltrBandpassCenterFreq'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'doublePtr'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxSetAIDigFltrBandpassCenterFreq ( TaskHandle taskHandle , const char channel [], float64 data ); 
fcns.name{fcnNum}='DAQmxSetAIDigFltrBandpassCenterFreq'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'double'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxResetAIDigFltrBandpassCenterFreq ( TaskHandle taskHandle , const char channel []); 
fcns.name{fcnNum}='DAQmxResetAIDigFltrBandpassCenterFreq'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxGetAIDigFltrBandpassWidth ( TaskHandle taskHandle , const char channel [], float64 * data ); 
fcns.name{fcnNum}='DAQmxGetAIDigFltrBandpassWidth'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'doublePtr'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxSetAIDigFltrBandpassWidth ( TaskHandle taskHandle , const char channel [], float64 data ); 
fcns.name{fcnNum}='DAQmxSetAIDigFltrBandpassWidth'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'double'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxResetAIDigFltrBandpassWidth ( TaskHandle taskHandle , const char channel []); 
fcns.name{fcnNum}='DAQmxResetAIDigFltrBandpassWidth'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxGetAIDigFltrNotchCenterFreq ( TaskHandle taskHandle , const char channel [], float64 * data ); 
fcns.name{fcnNum}='DAQmxGetAIDigFltrNotchCenterFreq'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'doublePtr'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxSetAIDigFltrNotchCenterFreq ( TaskHandle taskHandle , const char channel [], float64 data ); 
fcns.name{fcnNum}='DAQmxSetAIDigFltrNotchCenterFreq'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'double'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxResetAIDigFltrNotchCenterFreq ( TaskHandle taskHandle , const char channel []); 
fcns.name{fcnNum}='DAQmxResetAIDigFltrNotchCenterFreq'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxGetAIDigFltrNotchWidth ( TaskHandle taskHandle , const char channel [], float64 * data ); 
fcns.name{fcnNum}='DAQmxGetAIDigFltrNotchWidth'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'doublePtr'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxSetAIDigFltrNotchWidth ( TaskHandle taskHandle , const char channel [], float64 data ); 
fcns.name{fcnNum}='DAQmxSetAIDigFltrNotchWidth'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'double'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxResetAIDigFltrNotchWidth ( TaskHandle taskHandle , const char channel []); 
fcns.name{fcnNum}='DAQmxResetAIDigFltrNotchWidth'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxGetAIDigFltrCoeff ( TaskHandle taskHandle , const char channel [], float64 * data , uInt32 arraySizeInElements ); 
fcns.name{fcnNum}='DAQmxGetAIDigFltrCoeff'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'doublePtr', 'ulong'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxSetAIDigFltrCoeff ( TaskHandle taskHandle , const char channel [], float64 * data , uInt32 arraySizeInElements ); 
fcns.name{fcnNum}='DAQmxSetAIDigFltrCoeff'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'doublePtr', 'ulong'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxResetAIDigFltrCoeff ( TaskHandle taskHandle , const char channel []); 
fcns.name{fcnNum}='DAQmxResetAIDigFltrCoeff'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring'};fcnNum=fcnNum+1;
...
% int32 __stdcall DAQmxGetAIFilterDelayUnits ( TaskHandle taskHandle , const char channel [], int32 * data ); 
fcns.name{fcnNum}='DAQmxGetAIFilterDelayUnits'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'longPtr'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxSetAIFilterDelayUnits ( TaskHandle taskHandle , const char channel [], int32 data ); 
fcns.name{fcnNum}='DAQmxSetAIFilterDelayUnits'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'long'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxResetAIFilterDelayUnits ( TaskHandle taskHandle , const char channel []); 
fcns.name{fcnNum}='DAQmxResetAIFilterDelayUnits'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring'};fcnNum=fcnNum+1;
...
% int32 __stdcall DAQmxGetAIFilterDelayAdjustment ( TaskHandle taskHandle , const char channel [], float64 * data ); 
fcns.name{fcnNum}='DAQmxGetAIFilterDelayAdjustment'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'doublePtr'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxSetAIFilterDelayAdjustment ( TaskHandle taskHandle , const char channel [], float64 data ); 
fcns.name{fcnNum}='DAQmxSetAIFilterDelayAdjustment'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'double'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxResetAIFilterDelayAdjustment ( TaskHandle taskHandle , const char channel []); 
fcns.name{fcnNum}='DAQmxResetAIFilterDelayAdjustment'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring'};fcnNum=fcnNum+1;
...
fcns.name{fcnNum}='DAQmxGetAIUsbXferReqCount'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'ulongPtr'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxSetAIUsbXferReqCount ( TaskHandle taskHandle , const char channel [], uInt32 data ); 
fcns.name{fcnNum}='DAQmxSetAIUsbXferReqCount'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'ulong'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxResetAIUsbXferReqCount ( TaskHandle taskHandle , const char channel []); 
fcns.name{fcnNum}='DAQmxResetAIUsbXferReqCount'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring'};fcnNum=fcnNum+1;
...
% int32 __stdcall DAQmxGetAOFilterDelay ( TaskHandle taskHandle , const char channel [], float64 * data ); 
fcns.name{fcnNum}='DAQmxGetAOFilterDelay'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'doublePtr'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxSetAOFilterDelay ( TaskHandle taskHandle , const char channel [], float64 data ); 
fcns.name{fcnNum}='DAQmxSetAOFilterDelay'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'double'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxResetAOFilterDelay ( TaskHandle taskHandle , const char channel []); 
fcns.name{fcnNum}='DAQmxResetAOFilterDelay'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxGetAOFilterDelayUnits ( TaskHandle taskHandle , const char channel [], int32 * data ); 
fcns.name{fcnNum}='DAQmxGetAOFilterDelayUnits'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'longPtr'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxSetAOFilterDelayUnits ( TaskHandle taskHandle , const char channel [], int32 data ); 
fcns.name{fcnNum}='DAQmxSetAOFilterDelayUnits'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'long'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxResetAOFilterDelayUnits ( TaskHandle taskHandle , const char channel []); 
fcns.name{fcnNum}='DAQmxResetAOFilterDelayUnits'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxGetAOFilterDelayAdjustment ( TaskHandle taskHandle , const char channel [], float64 * data ); 
fcns.name{fcnNum}='DAQmxGetAOFilterDelayAdjustment'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'doublePtr'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxSetAOFilterDelayAdjustment ( TaskHandle taskHandle , const char channel [], float64 data ); 
fcns.name{fcnNum}='DAQmxSetAOFilterDelayAdjustment'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'double'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxResetAOFilterDelayAdjustment ( TaskHandle taskHandle , const char channel []); 
fcns.name{fcnNum}='DAQmxResetAOFilterDelayAdjustment'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring'};fcnNum=fcnNum+1;
...
fcns.name{fcnNum}='DAQmxGetAOUsbXferReqCount'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'ulongPtr'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxSetAOUsbXferReqCount ( TaskHandle taskHandle , const char channel [], uInt32 data ); 
fcns.name{fcnNum}='DAQmxSetAOUsbXferReqCount'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'ulong'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxResetAOUsbXferReqCount ( TaskHandle taskHandle , const char channel []); 
fcns.name{fcnNum}='DAQmxResetAOUsbXferReqCount'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring'};fcnNum=fcnNum+1;
...
fcns.name{fcnNum}='DAQmxGetDIUsbXferReqCount'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'ulongPtr'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxSetDIUsbXferReqCount ( TaskHandle taskHandle , const char channel [], uInt32 data ); 
fcns.name{fcnNum}='DAQmxSetDIUsbXferReqCount'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'ulong'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxResetDIUsbXferReqCount ( TaskHandle taskHandle , const char channel []); 
fcns.name{fcnNum}='DAQmxResetDIUsbXferReqCount'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring'};fcnNum=fcnNum+1;
...
fcns.name{fcnNum}='DAQmxGetDOUsbXferReqCount'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'ulongPtr'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxSetDOUsbXferReqCount ( TaskHandle taskHandle , const char channel [], uInt32 data ); 
fcns.name{fcnNum}='DAQmxSetDOUsbXferReqCount'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'ulong'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxResetDOUsbXferReqCount ( TaskHandle taskHandle , const char channel []); 
fcns.name{fcnNum}='DAQmxResetDOUsbXferReqCount'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring'};fcnNum=fcnNum+1;
...
% int32 __stdcall DAQmxGetCIFreqTermCfg ( TaskHandle taskHandle , const char channel [], int32 * data ); 
fcns.name{fcnNum}='DAQmxGetCIFreqTermCfg'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'longPtr'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxSetCIFreqTermCfg ( TaskHandle taskHandle , const char channel [], int32 data ); 
fcns.name{fcnNum}='DAQmxSetCIFreqTermCfg'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'long'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxResetCIFreqTermCfg ( TaskHandle taskHandle , const char channel []); 
fcns.name{fcnNum}='DAQmxResetCIFreqTermCfg'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxGetCIFreqLogicLvlBehavior ( TaskHandle taskHandle , const char channel [], int32 * data ); 
fcns.name{fcnNum}='DAQmxGetCIFreqLogicLvlBehavior'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'longPtr'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxSetCIFreqLogicLvlBehavior ( TaskHandle taskHandle , const char channel [], int32 data ); 
fcns.name{fcnNum}='DAQmxSetCIFreqLogicLvlBehavior'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'long'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxResetCIFreqLogicLvlBehavior ( TaskHandle taskHandle , const char channel []); 
fcns.name{fcnNum}='DAQmxResetCIFreqLogicLvlBehavior'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring'};fcnNum=fcnNum+1;
...
% int32 __stdcall DAQmxGetCIPeriodTermCfg ( TaskHandle taskHandle , const char channel [], int32 * data ); 
fcns.name{fcnNum}='DAQmxGetCIPeriodTermCfg'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'longPtr'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxSetCIPeriodTermCfg ( TaskHandle taskHandle , const char channel [], int32 data ); 
fcns.name{fcnNum}='DAQmxSetCIPeriodTermCfg'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'long'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxResetCIPeriodTermCfg ( TaskHandle taskHandle , const char channel []); 
fcns.name{fcnNum}='DAQmxResetCIPeriodTermCfg'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxGetCIPeriodLogicLvlBehavior ( TaskHandle taskHandle , const char channel [], int32 * data ); 
fcns.name{fcnNum}='DAQmxGetCIPeriodLogicLvlBehavior'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'longPtr'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxSetCIPeriodLogicLvlBehavior ( TaskHandle taskHandle , const char channel [], int32 data ); 
fcns.name{fcnNum}='DAQmxSetCIPeriodLogicLvlBehavior'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'long'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxResetCIPeriodLogicLvlBehavior ( TaskHandle taskHandle , const char channel []); 
fcns.name{fcnNum}='DAQmxResetCIPeriodLogicLvlBehavior'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring'};fcnNum=fcnNum+1;
...
% int32 __stdcall DAQmxGetCICountEdgesTermCfg ( TaskHandle taskHandle , const char channel [], int32 * data ); 
fcns.name{fcnNum}='DAQmxGetCICountEdgesTermCfg'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'longPtr'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxSetCICountEdgesTermCfg ( TaskHandle taskHandle , const char channel [], int32 data ); 
fcns.name{fcnNum}='DAQmxSetCICountEdgesTermCfg'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'long'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxResetCICountEdgesTermCfg ( TaskHandle taskHandle , const char channel []); 
fcns.name{fcnNum}='DAQmxResetCICountEdgesTermCfg'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxGetCICountEdgesLogicLvlBehavior ( TaskHandle taskHandle , const char channel [], int32 * data ); 
fcns.name{fcnNum}='DAQmxGetCICountEdgesLogicLvlBehavior'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'longPtr'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxSetCICountEdgesLogicLvlBehavior ( TaskHandle taskHandle , const char channel [], int32 data ); 
fcns.name{fcnNum}='DAQmxSetCICountEdgesLogicLvlBehavior'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'long'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxResetCICountEdgesLogicLvlBehavior ( TaskHandle taskHandle , const char channel []); 
fcns.name{fcnNum}='DAQmxResetCICountEdgesLogicLvlBehavior'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring'};fcnNum=fcnNum+1;
...
% int32 __stdcall DAQmxGetCICountEdgesCountDirTermCfg ( TaskHandle taskHandle , const char channel [], int32 * data ); 
fcns.name{fcnNum}='DAQmxGetCICountEdgesCountDirTermCfg'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'longPtr'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxSetCICountEdgesCountDirTermCfg ( TaskHandle taskHandle , const char channel [], int32 data ); 
fcns.name{fcnNum}='DAQmxSetCICountEdgesCountDirTermCfg'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'long'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxResetCICountEdgesCountDirTermCfg ( TaskHandle taskHandle , const char channel []); 
fcns.name{fcnNum}='DAQmxResetCICountEdgesCountDirTermCfg'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxGetCICountEdgesCountDirLogicLvlBehavior ( TaskHandle taskHandle , const char channel [], int32 * data ); 
fcns.name{fcnNum}='DAQmxGetCICountEdgesCountDirLogicLvlBehavior'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'longPtr'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxSetCICountEdgesCountDirLogicLvlBehavior ( TaskHandle taskHandle , const char channel [], int32 data ); 
fcns.name{fcnNum}='DAQmxSetCICountEdgesCountDirLogicLvlBehavior'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'long'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxResetCICountEdgesCountDirLogicLvlBehavior ( TaskHandle taskHandle , const char channel []); 
fcns.name{fcnNum}='DAQmxResetCICountEdgesCountDirLogicLvlBehavior'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring'};fcnNum=fcnNum+1;
...
% int32 __stdcall DAQmxGetCICountEdgesCountResetTermCfg ( TaskHandle taskHandle , const char channel [], int32 * data ); 
fcns.name{fcnNum}='DAQmxGetCICountEdgesCountResetTermCfg'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'longPtr'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxSetCICountEdgesCountResetTermCfg ( TaskHandle taskHandle , const char channel [], int32 data ); 
fcns.name{fcnNum}='DAQmxSetCICountEdgesCountResetTermCfg'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'long'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxResetCICountEdgesCountResetTermCfg ( TaskHandle taskHandle , const char channel []); 
fcns.name{fcnNum}='DAQmxResetCICountEdgesCountResetTermCfg'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxGetCICountEdgesCountResetLogicLvlBehavior ( TaskHandle taskHandle , const char channel [], int32 * data ); 
fcns.name{fcnNum}='DAQmxGetCICountEdgesCountResetLogicLvlBehavior'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'longPtr'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxSetCICountEdgesCountResetLogicLvlBehavior ( TaskHandle taskHandle , const char channel [], int32 data ); 
fcns.name{fcnNum}='DAQmxSetCICountEdgesCountResetLogicLvlBehavior'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'long'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxResetCICountEdgesCountResetLogicLvlBehavior ( TaskHandle taskHandle , const char channel []); 
fcns.name{fcnNum}='DAQmxResetCICountEdgesCountResetLogicLvlBehavior'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring'};fcnNum=fcnNum+1;
...
% int32 __stdcall DAQmxGetCIDutyCycleTerm ( TaskHandle taskHandle , const char channel [], char * data , uInt32 bufferSize ); 
fcns.name{fcnNum}='DAQmxGetCIDutyCycleTerm'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'cstring', 'ulong'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxSetCIDutyCycleTerm ( TaskHandle taskHandle , const char channel [], const char * data ); 
fcns.name{fcnNum}='DAQmxSetCIDutyCycleTerm'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'cstring'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxResetCIDutyCycleTerm ( TaskHandle taskHandle , const char channel []); 
fcns.name{fcnNum}='DAQmxResetCIDutyCycleTerm'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxGetCIDutyCycleTermCfg ( TaskHandle taskHandle , const char channel [], int32 * data ); 
fcns.name{fcnNum}='DAQmxGetCIDutyCycleTermCfg'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'longPtr'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxSetCIDutyCycleTermCfg ( TaskHandle taskHandle , const char channel [], int32 data ); 
fcns.name{fcnNum}='DAQmxSetCIDutyCycleTermCfg'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'long'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxResetCIDutyCycleTermCfg ( TaskHandle taskHandle , const char channel []); 
fcns.name{fcnNum}='DAQmxResetCIDutyCycleTermCfg'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxGetCIDutyCycleLogicLvlBehavior ( TaskHandle taskHandle , const char channel [], int32 * data ); 
fcns.name{fcnNum}='DAQmxGetCIDutyCycleLogicLvlBehavior'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'longPtr'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxSetCIDutyCycleLogicLvlBehavior ( TaskHandle taskHandle , const char channel [], int32 data ); 
fcns.name{fcnNum}='DAQmxSetCIDutyCycleLogicLvlBehavior'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'long'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxResetCIDutyCycleLogicLvlBehavior ( TaskHandle taskHandle , const char channel []); 
fcns.name{fcnNum}='DAQmxResetCIDutyCycleLogicLvlBehavior'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxGetCIDutyCycleDigFltrEnable ( TaskHandle taskHandle , const char channel [], bool32 * data ); 
fcns.name{fcnNum}='DAQmxGetCIDutyCycleDigFltrEnable'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'ulongPtr'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxSetCIDutyCycleDigFltrEnable ( TaskHandle taskHandle , const char channel [], bool32 data ); 
fcns.name{fcnNum}='DAQmxSetCIDutyCycleDigFltrEnable'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'ulong'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxResetCIDutyCycleDigFltrEnable ( TaskHandle taskHandle , const char channel []); 
fcns.name{fcnNum}='DAQmxResetCIDutyCycleDigFltrEnable'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxGetCIDutyCycleDigFltrMinPulseWidth ( TaskHandle taskHandle , const char channel [], float64 * data ); 
fcns.name{fcnNum}='DAQmxGetCIDutyCycleDigFltrMinPulseWidth'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'doublePtr'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxSetCIDutyCycleDigFltrMinPulseWidth ( TaskHandle taskHandle , const char channel [], float64 data ); 
fcns.name{fcnNum}='DAQmxSetCIDutyCycleDigFltrMinPulseWidth'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'double'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxResetCIDutyCycleDigFltrMinPulseWidth ( TaskHandle taskHandle , const char channel []); 
fcns.name{fcnNum}='DAQmxResetCIDutyCycleDigFltrMinPulseWidth'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxGetCIDutyCycleDigFltrTimebaseSrc ( TaskHandle taskHandle , const char channel [], char * data , uInt32 bufferSize ); 
fcns.name{fcnNum}='DAQmxGetCIDutyCycleDigFltrTimebaseSrc'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'cstring', 'ulong'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxSetCIDutyCycleDigFltrTimebaseSrc ( TaskHandle taskHandle , const char channel [], const char * data ); 
fcns.name{fcnNum}='DAQmxSetCIDutyCycleDigFltrTimebaseSrc'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'cstring'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxResetCIDutyCycleDigFltrTimebaseSrc ( TaskHandle taskHandle , const char channel []); 
fcns.name{fcnNum}='DAQmxResetCIDutyCycleDigFltrTimebaseSrc'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxGetCIDutyCycleDigFltrTimebaseRate ( TaskHandle taskHandle , const char channel [], float64 * data ); 
fcns.name{fcnNum}='DAQmxGetCIDutyCycleDigFltrTimebaseRate'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'doublePtr'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxSetCIDutyCycleDigFltrTimebaseRate ( TaskHandle taskHandle , const char channel [], float64 data ); 
fcns.name{fcnNum}='DAQmxSetCIDutyCycleDigFltrTimebaseRate'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'double'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxResetCIDutyCycleDigFltrTimebaseRate ( TaskHandle taskHandle , const char channel []); 
fcns.name{fcnNum}='DAQmxResetCIDutyCycleDigFltrTimebaseRate'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxGetCIDutyCycleStartingEdge ( TaskHandle taskHandle , const char channel [], int32 * data ); 
fcns.name{fcnNum}='DAQmxGetCIDutyCycleStartingEdge'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'longPtr'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxSetCIDutyCycleStartingEdge ( TaskHandle taskHandle , const char channel [], int32 data ); 
fcns.name{fcnNum}='DAQmxSetCIDutyCycleStartingEdge'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'long'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxResetCIDutyCycleStartingEdge ( TaskHandle taskHandle , const char channel []); 
fcns.name{fcnNum}='DAQmxResetCIDutyCycleStartingEdge'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring'};fcnNum=fcnNum+1;
...
% int32 __stdcall DAQmxGetCIEncoderAInputTermCfg ( TaskHandle taskHandle , const char channel [], int32 * data ); 
fcns.name{fcnNum}='DAQmxGetCIEncoderAInputTermCfg'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'longPtr'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxSetCIEncoderAInputTermCfg ( TaskHandle taskHandle , const char channel [], int32 data ); 
fcns.name{fcnNum}='DAQmxSetCIEncoderAInputTermCfg'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'long'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxResetCIEncoderAInputTermCfg ( TaskHandle taskHandle , const char channel []); 
fcns.name{fcnNum}='DAQmxResetCIEncoderAInputTermCfg'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxGetCIEncoderAInputLogicLvlBehavior ( TaskHandle taskHandle , const char channel [], int32 * data ); 
fcns.name{fcnNum}='DAQmxGetCIEncoderAInputLogicLvlBehavior'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'longPtr'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxSetCIEncoderAInputLogicLvlBehavior ( TaskHandle taskHandle , const char channel [], int32 data ); 
fcns.name{fcnNum}='DAQmxSetCIEncoderAInputLogicLvlBehavior'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'long'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxResetCIEncoderAInputLogicLvlBehavior ( TaskHandle taskHandle , const char channel []); 
fcns.name{fcnNum}='DAQmxResetCIEncoderAInputLogicLvlBehavior'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring'};fcnNum=fcnNum+1;
...
% int32 __stdcall DAQmxGetCIEncoderBInputTermCfg ( TaskHandle taskHandle , const char channel [], int32 * data ); 
fcns.name{fcnNum}='DAQmxGetCIEncoderBInputTermCfg'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'longPtr'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxSetCIEncoderBInputTermCfg ( TaskHandle taskHandle , const char channel [], int32 data ); 
fcns.name{fcnNum}='DAQmxSetCIEncoderBInputTermCfg'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'long'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxResetCIEncoderBInputTermCfg ( TaskHandle taskHandle , const char channel []); 
fcns.name{fcnNum}='DAQmxResetCIEncoderBInputTermCfg'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxGetCIEncoderBInputLogicLvlBehavior ( TaskHandle taskHandle , const char channel [], int32 * data ); 
fcns.name{fcnNum}='DAQmxGetCIEncoderBInputLogicLvlBehavior'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'longPtr'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxSetCIEncoderBInputLogicLvlBehavior ( TaskHandle taskHandle , const char channel [], int32 data ); 
fcns.name{fcnNum}='DAQmxSetCIEncoderBInputLogicLvlBehavior'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'long'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxResetCIEncoderBInputLogicLvlBehavior ( TaskHandle taskHandle , const char channel []); 
fcns.name{fcnNum}='DAQmxResetCIEncoderBInputLogicLvlBehavior'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring'};fcnNum=fcnNum+1;
...
% int32 __stdcall DAQmxGetCIEncoderZInputTermCfg ( TaskHandle taskHandle , const char channel [], int32 * data ); 
fcns.name{fcnNum}='DAQmxGetCIEncoderZInputTermCfg'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'longPtr'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxSetCIEncoderZInputTermCfg ( TaskHandle taskHandle , const char channel [], int32 data ); 
fcns.name{fcnNum}='DAQmxSetCIEncoderZInputTermCfg'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'long'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxResetCIEncoderZInputTermCfg ( TaskHandle taskHandle , const char channel []); 
fcns.name{fcnNum}='DAQmxResetCIEncoderZInputTermCfg'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxGetCIEncoderZInputLogicLvlBehavior ( TaskHandle taskHandle , const char channel [], int32 * data ); 
fcns.name{fcnNum}='DAQmxGetCIEncoderZInputLogicLvlBehavior'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'longPtr'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxSetCIEncoderZInputLogicLvlBehavior ( TaskHandle taskHandle , const char channel [], int32 data ); 
fcns.name{fcnNum}='DAQmxSetCIEncoderZInputLogicLvlBehavior'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'long'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxResetCIEncoderZInputLogicLvlBehavior ( TaskHandle taskHandle , const char channel []); 
fcns.name{fcnNum}='DAQmxResetCIEncoderZInputLogicLvlBehavior'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring'};fcnNum=fcnNum+1;
...
% int32 __stdcall DAQmxGetCIPulseWidthTermCfg ( TaskHandle taskHandle , const char channel [], int32 * data ); 
fcns.name{fcnNum}='DAQmxGetCIPulseWidthTermCfg'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'longPtr'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxSetCIPulseWidthTermCfg ( TaskHandle taskHandle , const char channel [], int32 data ); 
fcns.name{fcnNum}='DAQmxSetCIPulseWidthTermCfg'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'long'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxResetCIPulseWidthTermCfg ( TaskHandle taskHandle , const char channel []); 
fcns.name{fcnNum}='DAQmxResetCIPulseWidthTermCfg'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxGetCIPulseWidthLogicLvlBehavior ( TaskHandle taskHandle , const char channel [], int32 * data ); 
fcns.name{fcnNum}='DAQmxGetCIPulseWidthLogicLvlBehavior'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'longPtr'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxSetCIPulseWidthLogicLvlBehavior ( TaskHandle taskHandle , const char channel [], int32 data ); 
fcns.name{fcnNum}='DAQmxSetCIPulseWidthLogicLvlBehavior'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'long'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxResetCIPulseWidthLogicLvlBehavior ( TaskHandle taskHandle , const char channel []); 
fcns.name{fcnNum}='DAQmxResetCIPulseWidthLogicLvlBehavior'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring'};fcnNum=fcnNum+1;
...
% int32 __stdcall DAQmxGetCITwoEdgeSepFirstTermCfg ( TaskHandle taskHandle , const char channel [], int32 * data ); 
fcns.name{fcnNum}='DAQmxGetCITwoEdgeSepFirstTermCfg'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'longPtr'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxSetCITwoEdgeSepFirstTermCfg ( TaskHandle taskHandle , const char channel [], int32 data ); 
fcns.name{fcnNum}='DAQmxSetCITwoEdgeSepFirstTermCfg'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'long'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxResetCITwoEdgeSepFirstTermCfg ( TaskHandle taskHandle , const char channel []); 
fcns.name{fcnNum}='DAQmxResetCITwoEdgeSepFirstTermCfg'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxGetCITwoEdgeSepFirstLogicLvlBehavior ( TaskHandle taskHandle , const char channel [], int32 * data ); 
fcns.name{fcnNum}='DAQmxGetCITwoEdgeSepFirstLogicLvlBehavior'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'longPtr'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxSetCITwoEdgeSepFirstLogicLvlBehavior ( TaskHandle taskHandle , const char channel [], int32 data ); 
fcns.name{fcnNum}='DAQmxSetCITwoEdgeSepFirstLogicLvlBehavior'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'long'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxResetCITwoEdgeSepFirstLogicLvlBehavior ( TaskHandle taskHandle , const char channel []); 
fcns.name{fcnNum}='DAQmxResetCITwoEdgeSepFirstLogicLvlBehavior'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring'};fcnNum=fcnNum+1;
...
% int32 __stdcall DAQmxGetCITwoEdgeSepSecondTermCfg ( TaskHandle taskHandle , const char channel [], int32 * data ); 
fcns.name{fcnNum}='DAQmxGetCITwoEdgeSepSecondTermCfg'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'longPtr'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxSetCITwoEdgeSepSecondTermCfg ( TaskHandle taskHandle , const char channel [], int32 data ); 
fcns.name{fcnNum}='DAQmxSetCITwoEdgeSepSecondTermCfg'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'long'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxResetCITwoEdgeSepSecondTermCfg ( TaskHandle taskHandle , const char channel []); 
fcns.name{fcnNum}='DAQmxResetCITwoEdgeSepSecondTermCfg'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxGetCITwoEdgeSepSecondLogicLvlBehavior ( TaskHandle taskHandle , const char channel [], int32 * data ); 
fcns.name{fcnNum}='DAQmxGetCITwoEdgeSepSecondLogicLvlBehavior'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'longPtr'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxSetCITwoEdgeSepSecondLogicLvlBehavior ( TaskHandle taskHandle , const char channel [], int32 data ); 
fcns.name{fcnNum}='DAQmxSetCITwoEdgeSepSecondLogicLvlBehavior'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'long'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxResetCITwoEdgeSepSecondLogicLvlBehavior ( TaskHandle taskHandle , const char channel []); 
fcns.name{fcnNum}='DAQmxResetCITwoEdgeSepSecondLogicLvlBehavior'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring'};fcnNum=fcnNum+1;
...
% int32 __stdcall DAQmxGetCISemiPeriodTermCfg ( TaskHandle taskHandle , const char channel [], int32 * data ); 
fcns.name{fcnNum}='DAQmxGetCISemiPeriodTermCfg'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'longPtr'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxSetCISemiPeriodTermCfg ( TaskHandle taskHandle , const char channel [], int32 data ); 
fcns.name{fcnNum}='DAQmxSetCISemiPeriodTermCfg'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'long'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxResetCISemiPeriodTermCfg ( TaskHandle taskHandle , const char channel []); 
fcns.name{fcnNum}='DAQmxResetCISemiPeriodTermCfg'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxGetCISemiPeriodLogicLvlBehavior ( TaskHandle taskHandle , const char channel [], int32 * data ); 
fcns.name{fcnNum}='DAQmxGetCISemiPeriodLogicLvlBehavior'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'longPtr'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxSetCISemiPeriodLogicLvlBehavior ( TaskHandle taskHandle , const char channel [], int32 data ); 
fcns.name{fcnNum}='DAQmxSetCISemiPeriodLogicLvlBehavior'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'long'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxResetCISemiPeriodLogicLvlBehavior ( TaskHandle taskHandle , const char channel []); 
fcns.name{fcnNum}='DAQmxResetCISemiPeriodLogicLvlBehavior'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring'};fcnNum=fcnNum+1;
...
% int32 __stdcall DAQmxGetCIPulseFreqTermCfg ( TaskHandle taskHandle , const char channel [], int32 * data ); 
fcns.name{fcnNum}='DAQmxGetCIPulseFreqTermCfg'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'longPtr'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxSetCIPulseFreqTermCfg ( TaskHandle taskHandle , const char channel [], int32 data ); 
fcns.name{fcnNum}='DAQmxSetCIPulseFreqTermCfg'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'long'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxResetCIPulseFreqTermCfg ( TaskHandle taskHandle , const char channel []); 
fcns.name{fcnNum}='DAQmxResetCIPulseFreqTermCfg'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxGetCIPulseFreqLogicLvlBehavior ( TaskHandle taskHandle , const char channel [], int32 * data ); 
fcns.name{fcnNum}='DAQmxGetCIPulseFreqLogicLvlBehavior'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'longPtr'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxSetCIPulseFreqLogicLvlBehavior ( TaskHandle taskHandle , const char channel [], int32 data ); 
fcns.name{fcnNum}='DAQmxSetCIPulseFreqLogicLvlBehavior'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'long'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxResetCIPulseFreqLogicLvlBehavior ( TaskHandle taskHandle , const char channel []); 
fcns.name{fcnNum}='DAQmxResetCIPulseFreqLogicLvlBehavior'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring'};fcnNum=fcnNum+1;
...
% int32 __stdcall DAQmxGetCIPulseTimeTermCfg ( TaskHandle taskHandle , const char channel [], int32 * data ); 
fcns.name{fcnNum}='DAQmxGetCIPulseTimeTermCfg'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'longPtr'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxSetCIPulseTimeTermCfg ( TaskHandle taskHandle , const char channel [], int32 data ); 
fcns.name{fcnNum}='DAQmxSetCIPulseTimeTermCfg'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'long'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxResetCIPulseTimeTermCfg ( TaskHandle taskHandle , const char channel []); 
fcns.name{fcnNum}='DAQmxResetCIPulseTimeTermCfg'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxGetCIPulseTimeLogicLvlBehavior ( TaskHandle taskHandle , const char channel [], int32 * data ); 
fcns.name{fcnNum}='DAQmxGetCIPulseTimeLogicLvlBehavior'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'longPtr'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxSetCIPulseTimeLogicLvlBehavior ( TaskHandle taskHandle , const char channel [], int32 data ); 
fcns.name{fcnNum}='DAQmxSetCIPulseTimeLogicLvlBehavior'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'long'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxResetCIPulseTimeLogicLvlBehavior ( TaskHandle taskHandle , const char channel []); 
fcns.name{fcnNum}='DAQmxResetCIPulseTimeLogicLvlBehavior'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring'};fcnNum=fcnNum+1;
...
% int32 __stdcall DAQmxGetCIPulseTicksTermCfg ( TaskHandle taskHandle , const char channel [], int32 * data ); 
fcns.name{fcnNum}='DAQmxGetCIPulseTicksTermCfg'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'longPtr'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxSetCIPulseTicksTermCfg ( TaskHandle taskHandle , const char channel [], int32 data ); 
fcns.name{fcnNum}='DAQmxSetCIPulseTicksTermCfg'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'long'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxResetCIPulseTicksTermCfg ( TaskHandle taskHandle , const char channel []); 
fcns.name{fcnNum}='DAQmxResetCIPulseTicksTermCfg'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxGetCIPulseTicksLogicLvlBehavior ( TaskHandle taskHandle , const char channel [], int32 * data ); 
fcns.name{fcnNum}='DAQmxGetCIPulseTicksLogicLvlBehavior'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'longPtr'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxSetCIPulseTicksLogicLvlBehavior ( TaskHandle taskHandle , const char channel [], int32 data ); 
fcns.name{fcnNum}='DAQmxSetCIPulseTicksLogicLvlBehavior'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'long'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxResetCIPulseTicksLogicLvlBehavior ( TaskHandle taskHandle , const char channel []); 
fcns.name{fcnNum}='DAQmxResetCIPulseTicksLogicLvlBehavior'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring'};fcnNum=fcnNum+1;
...
% int32 __stdcall DAQmxGetCIThreshVoltage ( TaskHandle taskHandle , const char channel [], float64 * data ); 
fcns.name{fcnNum}='DAQmxGetCIThreshVoltage'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'doublePtr'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxSetCIThreshVoltage ( TaskHandle taskHandle , const char channel [], float64 data ); 
fcns.name{fcnNum}='DAQmxSetCIThreshVoltage'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'double'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxResetCIThreshVoltage ( TaskHandle taskHandle , const char channel []); 
fcns.name{fcnNum}='DAQmxResetCIThreshVoltage'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring'};fcnNum=fcnNum+1;
...
% int32 __stdcall DAQmxGetCISampClkOverrunBehavior ( TaskHandle taskHandle , const char channel [], int32 * data ); 
fcns.name{fcnNum}='DAQmxGetCISampClkOverrunBehavior'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'longPtr'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxSetCISampClkOverrunBehavior ( TaskHandle taskHandle , const char channel [], int32 data ); 
fcns.name{fcnNum}='DAQmxSetCISampClkOverrunBehavior'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'long'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxResetCISampClkOverrunBehavior ( TaskHandle taskHandle , const char channel []); 
fcns.name{fcnNum}='DAQmxResetCISampClkOverrunBehavior'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxGetCISampClkOverrunSentinelVal ( TaskHandle taskHandle , const char channel [], int32 * data ); 
fcns.name{fcnNum}='DAQmxGetCISampClkOverrunSentinelVal'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'longPtr'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxSetCISampClkOverrunSentinelVal ( TaskHandle taskHandle , const char channel [], int32 data ); 
fcns.name{fcnNum}='DAQmxSetCISampClkOverrunSentinelVal'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'long'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxResetCISampClkOverrunSentinelVal ( TaskHandle taskHandle , const char channel []); 
fcns.name{fcnNum}='DAQmxResetCISampClkOverrunSentinelVal'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring'};fcnNum=fcnNum+1;
...
fcns.name{fcnNum}='DAQmxGetCIUsbXferReqCount'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'ulongPtr'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxSetCIUsbXferReqCount ( TaskHandle taskHandle , const char channel [], uInt32 data ); 
fcns.name{fcnNum}='DAQmxSetCIUsbXferReqCount'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'ulong'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxResetCIUsbXferReqCount ( TaskHandle taskHandle , const char channel []); 
fcns.name{fcnNum}='DAQmxResetCIUsbXferReqCount'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring'};fcnNum=fcnNum+1;
...
% int32 __stdcall DAQmxGetCIMaxMeasPeriod ( TaskHandle taskHandle , const char channel [], float64 * data ); 
fcns.name{fcnNum}='DAQmxGetCIMaxMeasPeriod'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'doublePtr'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxSetCIMaxMeasPeriod ( TaskHandle taskHandle , const char channel [], float64 data ); 
fcns.name{fcnNum}='DAQmxSetCIMaxMeasPeriod'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'double'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxResetCIMaxMeasPeriod ( TaskHandle taskHandle , const char channel []); 
fcns.name{fcnNum}='DAQmxResetCIMaxMeasPeriod'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring'};fcnNum=fcnNum+1;
...
fcns.name{fcnNum}='DAQmxGetCOUsbXferReqCount'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'ulongPtr'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxSetCOUsbXferReqCount ( TaskHandle taskHandle , const char channel [], uInt32 data ); 
fcns.name{fcnNum}='DAQmxSetCOUsbXferReqCount'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'ulong'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxResetCOUsbXferReqCount ( TaskHandle taskHandle , const char channel []); 
fcns.name{fcnNum}='DAQmxResetCOUsbXferReqCount'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring'};fcnNum=fcnNum+1;
...
% int32 __stdcall DAQmxGetDevAIDigFltrLowpassCutoffFreqDiscreteVals ( const char device [], float64 * data , uInt32 arraySizeInElements ); 
fcns.name{fcnNum}='DAQmxGetDevAIDigFltrLowpassCutoffFreqDiscreteVals'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'cstring', 'doublePtr', 'ulong'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxGetDevAIDigFltrLowpassCutoffFreqRangeVals ( const char device [], float64 * data , uInt32 arraySizeInElements ); 
fcns.name{fcnNum}='DAQmxGetDevAIDigFltrLowpassCutoffFreqRangeVals'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'cstring', 'doublePtr', 'ulong'};fcnNum=fcnNum+1;
...
% int32 __stdcall DAQmxGetReadExcitFaultChansExist ( TaskHandle taskHandle , bool32 * data ); 
fcns.name{fcnNum}='DAQmxGetReadExcitFaultChansExist'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'ulongPtr'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxGetReadExcitFaultChans ( TaskHandle taskHandle , char * data , uInt32 bufferSize ); 
fcns.name{fcnNum}='DAQmxGetReadExcitFaultChans'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'ulong'};fcnNum=fcnNum+1;
...
% int32 __stdcall DAQmxGetReadOvertemperatureChansExist ( TaskHandle taskHandle , bool32 * data ); 
fcns.name{fcnNum}='DAQmxGetReadOvertemperatureChansExist'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'ulongPtr'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxGetReadOvertemperatureChans ( TaskHandle taskHandle , char * data , uInt32 bufferSize ); 
fcns.name{fcnNum}='DAQmxGetReadOvertemperatureChans'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'ulong'};fcnNum=fcnNum+1;
...
fcns.name{fcnNum}='DAQmxGetSwitchDevTemperature'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'cstring', 'doublePtr'};fcnNum=fcnNum+1;
...
% int32 __stdcall DAQmxGetTimingSyncPulseForce ( TaskHandle taskHandle , bool32 * data ); 
fcns.name{fcnNum}='DAQmxGetTimingSyncPulseForce'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'ulongPtr'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxSetTimingSyncPulseForce ( TaskHandle taskHandle , bool32 data ); 
fcns.name{fcnNum}='DAQmxSetTimingSyncPulseForce'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'ulong'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxResetTimingSyncPulseForce ( TaskHandle taskHandle ); 
fcns.name{fcnNum}='DAQmxResetTimingSyncPulseForce'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong'};fcnNum=fcnNum+1;
...
fcns.name{fcnNum}='DAQmxGetWatchdogExpirTrigTrigOnNetworkConnLoss'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'ulongPtr'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxSetWatchdogExpirTrigTrigOnNetworkConnLoss ( TaskHandle taskHandle , bool32 data ); 
fcns.name{fcnNum}='DAQmxSetWatchdogExpirTrigTrigOnNetworkConnLoss'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'ulong'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxResetWatchdogExpirTrigTrigOnNetworkConnLoss ( TaskHandle taskHandle ); 
fcns.name{fcnNum}='DAQmxResetWatchdogExpirTrigTrigOnNetworkConnLoss'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong'};fcnNum=fcnNum+1;
...
fcns.name{fcnNum}='DAQmxGetWatchdogAOOutputType'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'longPtr'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxSetWatchdogAOOutputType ( TaskHandle taskHandle , const char lines [], int32 data ); 
fcns.name{fcnNum}='DAQmxSetWatchdogAOOutputType'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'long'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxResetWatchdogAOOutputType ( TaskHandle taskHandle , const char lines []); 
fcns.name{fcnNum}='DAQmxResetWatchdogAOOutputType'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxGetWatchdogAOExpirState ( TaskHandle taskHandle , const char lines [], float64 * data ); 
fcns.name{fcnNum}='DAQmxGetWatchdogAOExpirState'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'doublePtr'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxSetWatchdogAOExpirState ( TaskHandle taskHandle , const char lines [], float64 data ); 
fcns.name{fcnNum}='DAQmxSetWatchdogAOExpirState'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'double'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxResetWatchdogAOExpirState ( TaskHandle taskHandle , const char lines []); 
fcns.name{fcnNum}='DAQmxResetWatchdogAOExpirState'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxGetWatchdogCOExpirState ( TaskHandle taskHandle , const char lines [], int32 * data ); 
fcns.name{fcnNum}='DAQmxGetWatchdogCOExpirState'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'longPtr'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxSetWatchdogCOExpirState ( TaskHandle taskHandle , const char lines [], int32 data ); 
fcns.name{fcnNum}='DAQmxSetWatchdogCOExpirState'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'long'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxResetWatchdogCOExpirState ( TaskHandle taskHandle , const char lines []); 
fcns.name{fcnNum}='DAQmxResetWatchdogCOExpirState'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring'};fcnNum=fcnNum+1;
...
% int32 __stdcall DAQmxGetWriteOvertemperatureChans ( TaskHandle taskHandle , char * data , uInt32 bufferSize ); 
fcns.name{fcnNum}='DAQmxGetWriteOvertemperatureChans'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'ulong'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxGetWriteExternalOvervoltageChansExist ( TaskHandle taskHandle , bool32 * data ); 
fcns.name{fcnNum}='DAQmxGetWriteExternalOvervoltageChansExist'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'ulongPtr'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxGetWriteExternalOvervoltageChans ( TaskHandle taskHandle , char * data , uInt32 bufferSize ); 
fcns.name{fcnNum}='DAQmxGetWriteExternalOvervoltageChans'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'ulong'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxGetWriteOverloadedChansExist ( TaskHandle taskHandle , bool32 * data ); 
fcns.name{fcnNum}='DAQmxGetWriteOverloadedChansExist'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'ulongPtr'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxGetWriteOverloadedChans ( TaskHandle taskHandle , char * data , uInt32 bufferSize ); 
fcns.name{fcnNum}='DAQmxGetWriteOverloadedChans'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'ulong'};fcnNum=fcnNum+1;
...
fcns.name{fcnNum}='DAQmxGetWriteAccessoryInsertionOrRemovalDetected'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'ulongPtr'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxGetWriteDevsWithInsertedOrRemovedAccessories ( TaskHandle taskHandle , char * data , uInt32 bufferSize ); 
fcns.name{fcnNum}='DAQmxGetWriteDevsWithInsertedOrRemovedAccessories'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'ulong'};fcnNum=fcnNum+1;
...
fcns.name{fcnNum}='DAQmxGetPhysicalChanAOSupportedPowerUpOutputTypes'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'cstring', 'longPtr', 'ulong'};fcnNum=fcnNum+1;
...
fcns.name{fcnNum}='DAQmxGetAOPowerAmpChannelEnable'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'cstring', 'ulongPtr'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxSetAOPowerAmpChannelEnable ( const char physicalChannel [], bool32 data ); 
fcns.name{fcnNum}='DAQmxSetAOPowerAmpChannelEnable'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'cstring', 'ulong'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxResetAOPowerAmpChannelEnable ( const char physicalChannel []); 
fcns.name{fcnNum}='DAQmxResetAOPowerAmpChannelEnable'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'cstring'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxGetAOPowerAmpScalingCoeff ( const char physicalChannel [], float64 * data , uInt32 arraySizeInElements ); 
fcns.name{fcnNum}='DAQmxGetAOPowerAmpScalingCoeff'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'cstring', 'doublePtr', 'ulong'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxGetAOPowerAmpOvercurrent ( const char physicalChannel [], bool32 * data ); 
fcns.name{fcnNum}='DAQmxGetAOPowerAmpOvercurrent'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'cstring', 'ulongPtr'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxGetAOPowerAmpGain ( const char physicalChannel [], float64 * data ); 
fcns.name{fcnNum}='DAQmxGetAOPowerAmpGain'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'cstring', 'doublePtr'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxGetAOPowerAmpOffset ( const char physicalChannel [], float64 * data ); 
fcns.name{fcnNum}='DAQmxGetAOPowerAmpOffset'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'cstring', 'doublePtr'};fcnNum=fcnNum+1;
