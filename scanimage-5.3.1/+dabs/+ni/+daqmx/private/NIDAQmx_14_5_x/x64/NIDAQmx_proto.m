...
%This function was generated by loadlibrary.m parser version  on Thu Apr 23 12:51:32 2015
...
fcns.thunkname{fcnNum}='longuint64cstringcstringdoubledoublelongcstringThunk';fcns.name{fcnNum}='DAQmxCreateCIDutyCycleChan'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'uint64', 'cstring', 'cstring', 'double', 'double', 'long', 'cstring'};fcnNum=fcnNum+1;
...
fcns.thunkname{fcnNum}='longuint64longdoubleulongvoidPtrulongvoidPtrvoidPtrThunk';fcns.name{fcnNum}='DAQmxReadCounterF64Ex'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'uint64', 'long', 'double', 'ulong', 'doublePtr', 'ulong', 'longPtr', 'ulongPtr'};fcnNum=fcnNum+1;
...
fcns.thunkname{fcnNum}='longuint64longdoubleulongvoidPtrulongvoidPtrvoidPtrThunk';fcns.name{fcnNum}='DAQmxReadCounterU32Ex'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'uint64', 'long', 'double', 'ulong', 'ulongPtr', 'ulong', 'longPtr', 'ulongPtr'};fcnNum=fcnNum+1;
...
fcns.thunkname{fcnNum}='longulongdoublevoidPtrThunk';fcns.name{fcnNum}='DAQmxAdjustDSAAOTimebaseCal'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'double', 'ulongPtr'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxSetupDSAAOTimebaseCal ( CalHandle calHandle , float64 * expectedFrequency ); 
fcns.thunkname{fcnNum}='longulongvoidPtrThunk';fcns.name{fcnNum}='DAQmxSetupDSAAOTimebaseCal'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'doublePtr'};fcnNum=fcnNum+1;
...
fcns.thunkname{fcnNum}='longulonglongdoublevoidPtrulongThunk';fcns.name{fcnNum}='DAQmxGet4463AdjustPoints'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'long', 'double', 'doublePtr', 'ulong'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxAdjust4463Cal ( CalHandle calHandle , const char channelNames [], float64 referenceVoltage ); 
fcns.thunkname{fcnNum}='longulongcstringdoubleThunk';fcns.name{fcnNum}='DAQmxAdjust4463Cal'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'double'};fcnNum=fcnNum+1;
...
fcns.thunkname{fcnNum}='longulongcstringlongdoubledoubleThunk';fcns.name{fcnNum}='DAQmxSetup4463Cal'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'long', 'double', 'double'};fcnNum=fcnNum+1;
...
fcns.thunkname{fcnNum}='longulongcstringlongdoubledoubledoubleThunk';fcns.name{fcnNum}='DAQmxSetup4339Cal'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'long', 'double', 'double', 'double'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxAdjust4339Cal ( CalHandle calHandle , float64 refVoltage ); 
fcns.thunkname{fcnNum}='longulongdoubleThunk';fcns.name{fcnNum}='DAQmxAdjust4339Cal'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'double'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxGet4339CalAdjustPoints ( CalHandle calHandle , float64 * adjustmentPoints , uInt32 bufferSize ); 
fcns.thunkname{fcnNum}='longulongvoidPtrulongThunk';fcns.name{fcnNum}='DAQmxGet4339CalAdjustPoints'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'doublePtr', 'ulong'};fcnNum=fcnNum+1;
...
fcns.thunkname{fcnNum}='longulongvoidPtrulongThunk';fcns.name{fcnNum}='DAQmxGet9209CalAdjustPoints'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'doublePtr', 'ulong'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxAdjust9209GainCal ( CalHandle calHandle , const char channelNames [], int32 terminalConfig , float64 value ); 
fcns.thunkname{fcnNum}='longulongcstringlongdoubleThunk';fcns.name{fcnNum}='DAQmxAdjust9209GainCal'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'long', 'double'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxAdjust9209OffsetCal ( CalHandle calHandle , const char channelNames []); 
fcns.thunkname{fcnNum}='longulongcstringThunk';fcns.name{fcnNum}='DAQmxAdjust9209OffsetCal'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring'};fcnNum=fcnNum+1;
...
fcns.thunkname{fcnNum}='longulongcstringvoidPtrulongThunk';fcns.name{fcnNum}='DAQmxGet9212CalAdjustPoints'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'doublePtr', 'ulong'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxAdjust9212Cal ( CalHandle calHandle , const char channelNames [], float64 value ); 
fcns.thunkname{fcnNum}='longulongcstringdoubleThunk';fcns.name{fcnNum}='DAQmxAdjust9212Cal'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'double'};fcnNum=fcnNum+1;
...
fcns.thunkname{fcnNum}='longulongvoidPtrulongThunk';fcns.name{fcnNum}='DAQmxGet9216CalAdjustPoints'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'doublePtr', 'ulong'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxAdjust9216Cal ( CalHandle calHandle , const char channelNames [], float64 value ); 
fcns.thunkname{fcnNum}='longulongcstringdoubleThunk';fcns.name{fcnNum}='DAQmxAdjust9216Cal'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'double'};fcnNum=fcnNum+1;
...
fcns.thunkname{fcnNum}='longulongcstringdoubledoublelongThunk';fcns.name{fcnNum}='DAQmxSetup9218Cal'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'double', 'double', 'long'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxGet9218CalAdjustPoints ( CalHandle calHandle , float64 * adjustmentPoints , uInt32 bufferSize ); 
fcns.thunkname{fcnNum}='longulongvoidPtrulongThunk';fcns.name{fcnNum}='DAQmxGet9218CalAdjustPoints'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'doublePtr', 'ulong'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxAdjust9218Cal ( CalHandle calHandle , const char channelNames [], float64 value ); 
fcns.thunkname{fcnNum}='longulongcstringdoubleThunk';fcns.name{fcnNum}='DAQmxAdjust9218Cal'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'double'};fcnNum=fcnNum+1;
...
fcns.thunkname{fcnNum}='longulongvoidPtrulongThunk';fcns.name{fcnNum}='DAQmxGet9226CalAdjustPoints'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'doublePtr', 'ulong'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxAdjust9226Cal ( CalHandle calHandle , const char channelNames [], float64 value ); 
fcns.thunkname{fcnNum}='longulongcstringdoubleThunk';fcns.name{fcnNum}='DAQmxAdjust9226Cal'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'double'};fcnNum=fcnNum+1;
...
fcns.thunkname{fcnNum}='longulongvoidPtrulongThunk';fcns.name{fcnNum}='DAQmxGet9230CalAdjustPoints'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'doublePtr', 'ulong'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxAdjust9230Cal ( CalHandle calHandle , const char channelNames [], float64 value ); 
fcns.thunkname{fcnNum}='longulongcstringdoubleThunk';fcns.name{fcnNum}='DAQmxAdjust9230Cal'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'double'};fcnNum=fcnNum+1;
...
fcns.thunkname{fcnNum}='longulongvoidPtrulongThunk';fcns.name{fcnNum}='DAQmxGet9238CalAdjustPoints'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'doublePtr', 'ulong'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxAdjust9238Cal ( CalHandle calHandle , const char channelNames [], float64 value ); 
fcns.thunkname{fcnNum}='longulongcstringdoubleThunk';fcns.name{fcnNum}='DAQmxAdjust9238Cal'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'double'};fcnNum=fcnNum+1;
...
fcns.thunkname{fcnNum}='longulongvoidPtrulongThunk';fcns.name{fcnNum}='DAQmxGet9242CalAdjustPoints'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'doublePtr', 'ulong'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxSetup9242Cal ( CalHandle calHandle , const char channelNames [], float64 value ); 
fcns.thunkname{fcnNum}='longulongcstringdoubleThunk';fcns.name{fcnNum}='DAQmxSetup9242Cal'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'double'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxAdjust9242Cal ( CalHandle calHandle , const char channelNames [], float64 value ); 
fcns.thunkname{fcnNum}='longulongcstringdoubleThunk';fcns.name{fcnNum}='DAQmxAdjust9242Cal'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'double'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxGet9244CalAdjustPoints ( CalHandle calHandle , float64 * adjustmentPoints , uInt32 bufferSize ); 
fcns.thunkname{fcnNum}='longulongvoidPtrulongThunk';fcns.name{fcnNum}='DAQmxGet9244CalAdjustPoints'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'doublePtr', 'ulong'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxSetup9244Cal ( CalHandle calHandle , const char channelNames [], float64 value ); 
fcns.thunkname{fcnNum}='longulongcstringdoubleThunk';fcns.name{fcnNum}='DAQmxSetup9244Cal'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'double'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxAdjust9244Cal ( CalHandle calHandle , const char channelNames [], float64 value ); 
fcns.thunkname{fcnNum}='longulongcstringdoubleThunk';fcns.name{fcnNum}='DAQmxAdjust9244Cal'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'double'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxGet9246CalAdjustPoints ( CalHandle calHandle , float64 * adjustmentPoints , uInt32 bufferSize ); 
fcns.thunkname{fcnNum}='longulongvoidPtrulongThunk';fcns.name{fcnNum}='DAQmxGet9246CalAdjustPoints'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'doublePtr', 'ulong'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxAdjust9246GainCal ( CalHandle calHandle , const char channelNames [], float64 value ); 
fcns.thunkname{fcnNum}='longulongcstringdoubleThunk';fcns.name{fcnNum}='DAQmxAdjust9246GainCal'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'double'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxAdjust9246OffsetCal ( CalHandle calHandle , const char channelNames []); 
fcns.thunkname{fcnNum}='longulongcstringThunk';fcns.name{fcnNum}='DAQmxAdjust9246OffsetCal'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxGet9247CalAdjustPoints ( CalHandle calHandle , float64 * adjustmentPoints , uInt32 bufferSize ); 
fcns.thunkname{fcnNum}='longulongvoidPtrulongThunk';fcns.name{fcnNum}='DAQmxGet9247CalAdjustPoints'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'doublePtr', 'ulong'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxAdjust9247GainCal ( CalHandle calHandle , const char channelNames [], float64 value ); 
fcns.thunkname{fcnNum}='longulongcstringdoubleThunk';fcns.name{fcnNum}='DAQmxAdjust9247GainCal'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring', 'double'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxAdjust9247OffsetCal ( CalHandle calHandle , const char channelNames []); 
fcns.thunkname{fcnNum}='longulongcstringThunk';fcns.name{fcnNum}='DAQmxAdjust9247OffsetCal'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'cstring'};fcnNum=fcnNum+1;
...
fcns.thunkname{fcnNum}='longuint64cstringvoidPtrThunk';fcns.name{fcnNum}='DAQmxGetAIBridgeShuntCalShuntCalASrc'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'uint64', 'cstring', 'longPtr'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxSetAIBridgeShuntCalShuntCalASrc ( TaskHandle taskHandle , const char channel [], int32 data ); 
fcns.thunkname{fcnNum}='longuint64cstringlongThunk';fcns.name{fcnNum}='DAQmxSetAIBridgeShuntCalShuntCalASrc'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'uint64', 'cstring', 'long'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxResetAIBridgeShuntCalShuntCalASrc ( TaskHandle taskHandle , const char channel []); 
fcns.thunkname{fcnNum}='longuint64cstringThunk';fcns.name{fcnNum}='DAQmxResetAIBridgeShuntCalShuntCalASrc'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'uint64', 'cstring'};fcnNum=fcnNum+1;
...
fcns.thunkname{fcnNum}='longuint64cstringvoidPtrThunk';fcns.name{fcnNum}='DAQmxGetAIBridgeShuntCalShuntCalBResistance'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'uint64', 'cstring', 'doublePtr'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxSetAIBridgeShuntCalShuntCalBResistance ( TaskHandle taskHandle , const char channel [], float64 data ); 
fcns.thunkname{fcnNum}='longuint64cstringdoubleThunk';fcns.name{fcnNum}='DAQmxSetAIBridgeShuntCalShuntCalBResistance'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'uint64', 'cstring', 'double'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxResetAIBridgeShuntCalShuntCalBResistance ( TaskHandle taskHandle , const char channel []); 
fcns.thunkname{fcnNum}='longuint64cstringThunk';fcns.name{fcnNum}='DAQmxResetAIBridgeShuntCalShuntCalBResistance'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'uint64', 'cstring'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxGetAIBridgeShuntCalShuntCalBActualResistance ( TaskHandle taskHandle , const char channel [], float64 * data ); 
fcns.thunkname{fcnNum}='longuint64cstringvoidPtrThunk';fcns.name{fcnNum}='DAQmxGetAIBridgeShuntCalShuntCalBActualResistance'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'uint64', 'cstring', 'doublePtr'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxSetAIBridgeShuntCalShuntCalBActualResistance ( TaskHandle taskHandle , const char channel [], float64 data ); 
fcns.thunkname{fcnNum}='longuint64cstringdoubleThunk';fcns.name{fcnNum}='DAQmxSetAIBridgeShuntCalShuntCalBActualResistance'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'uint64', 'cstring', 'double'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxResetAIBridgeShuntCalShuntCalBActualResistance ( TaskHandle taskHandle , const char channel []); 
fcns.thunkname{fcnNum}='longuint64cstringThunk';fcns.name{fcnNum}='DAQmxResetAIBridgeShuntCalShuntCalBActualResistance'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'uint64', 'cstring'};fcnNum=fcnNum+1;
...
fcns.thunkname{fcnNum}='longuint64cstringvoidPtrThunk';fcns.name{fcnNum}='DAQmxGetAIExcitIdleOutputBehavior'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'uint64', 'cstring', 'longPtr'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxSetAIExcitIdleOutputBehavior ( TaskHandle taskHandle , const char channel [], int32 data ); 
fcns.thunkname{fcnNum}='longuint64cstringlongThunk';fcns.name{fcnNum}='DAQmxSetAIExcitIdleOutputBehavior'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'uint64', 'cstring', 'long'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxResetAIExcitIdleOutputBehavior ( TaskHandle taskHandle , const char channel []); 
fcns.thunkname{fcnNum}='longuint64cstringThunk';fcns.name{fcnNum}='DAQmxResetAIExcitIdleOutputBehavior'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'uint64', 'cstring'};fcnNum=fcnNum+1;
...
fcns.thunkname{fcnNum}='longuint64cstringvoidPtrThunk';fcns.name{fcnNum}='DAQmxGetAIDigFltrEnable'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'uint64', 'cstring', 'ulongPtr'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxSetAIDigFltrEnable ( TaskHandle taskHandle , const char channel [], bool32 data ); 
fcns.thunkname{fcnNum}='longuint64cstringulongThunk';fcns.name{fcnNum}='DAQmxSetAIDigFltrEnable'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'uint64', 'cstring', 'ulong'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxResetAIDigFltrEnable ( TaskHandle taskHandle , const char channel []); 
fcns.thunkname{fcnNum}='longuint64cstringThunk';fcns.name{fcnNum}='DAQmxResetAIDigFltrEnable'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'uint64', 'cstring'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxGetAIDigFltrType ( TaskHandle taskHandle , const char channel [], int32 * data ); 
fcns.thunkname{fcnNum}='longuint64cstringvoidPtrThunk';fcns.name{fcnNum}='DAQmxGetAIDigFltrType'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'uint64', 'cstring', 'longPtr'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxSetAIDigFltrType ( TaskHandle taskHandle , const char channel [], int32 data ); 
fcns.thunkname{fcnNum}='longuint64cstringlongThunk';fcns.name{fcnNum}='DAQmxSetAIDigFltrType'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'uint64', 'cstring', 'long'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxResetAIDigFltrType ( TaskHandle taskHandle , const char channel []); 
fcns.thunkname{fcnNum}='longuint64cstringThunk';fcns.name{fcnNum}='DAQmxResetAIDigFltrType'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'uint64', 'cstring'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxGetAIDigFltrResponse ( TaskHandle taskHandle , const char channel [], int32 * data ); 
fcns.thunkname{fcnNum}='longuint64cstringvoidPtrThunk';fcns.name{fcnNum}='DAQmxGetAIDigFltrResponse'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'uint64', 'cstring', 'longPtr'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxSetAIDigFltrResponse ( TaskHandle taskHandle , const char channel [], int32 data ); 
fcns.thunkname{fcnNum}='longuint64cstringlongThunk';fcns.name{fcnNum}='DAQmxSetAIDigFltrResponse'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'uint64', 'cstring', 'long'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxResetAIDigFltrResponse ( TaskHandle taskHandle , const char channel []); 
fcns.thunkname{fcnNum}='longuint64cstringThunk';fcns.name{fcnNum}='DAQmxResetAIDigFltrResponse'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'uint64', 'cstring'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxGetAIDigFltrOrder ( TaskHandle taskHandle , const char channel [], uInt32 * data ); 
fcns.thunkname{fcnNum}='longuint64cstringvoidPtrThunk';fcns.name{fcnNum}='DAQmxGetAIDigFltrOrder'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'uint64', 'cstring', 'ulongPtr'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxSetAIDigFltrOrder ( TaskHandle taskHandle , const char channel [], uInt32 data ); 
fcns.thunkname{fcnNum}='longuint64cstringulongThunk';fcns.name{fcnNum}='DAQmxSetAIDigFltrOrder'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'uint64', 'cstring', 'ulong'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxResetAIDigFltrOrder ( TaskHandle taskHandle , const char channel []); 
fcns.thunkname{fcnNum}='longuint64cstringThunk';fcns.name{fcnNum}='DAQmxResetAIDigFltrOrder'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'uint64', 'cstring'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxGetAIDigFltrLowpassCutoffFreq ( TaskHandle taskHandle , const char channel [], float64 * data ); 
fcns.thunkname{fcnNum}='longuint64cstringvoidPtrThunk';fcns.name{fcnNum}='DAQmxGetAIDigFltrLowpassCutoffFreq'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'uint64', 'cstring', 'doublePtr'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxSetAIDigFltrLowpassCutoffFreq ( TaskHandle taskHandle , const char channel [], float64 data ); 
fcns.thunkname{fcnNum}='longuint64cstringdoubleThunk';fcns.name{fcnNum}='DAQmxSetAIDigFltrLowpassCutoffFreq'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'uint64', 'cstring', 'double'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxResetAIDigFltrLowpassCutoffFreq ( TaskHandle taskHandle , const char channel []); 
fcns.thunkname{fcnNum}='longuint64cstringThunk';fcns.name{fcnNum}='DAQmxResetAIDigFltrLowpassCutoffFreq'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'uint64', 'cstring'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxGetAIDigFltrHighpassCutoffFreq ( TaskHandle taskHandle , const char channel [], float64 * data ); 
fcns.thunkname{fcnNum}='longuint64cstringvoidPtrThunk';fcns.name{fcnNum}='DAQmxGetAIDigFltrHighpassCutoffFreq'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'uint64', 'cstring', 'doublePtr'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxSetAIDigFltrHighpassCutoffFreq ( TaskHandle taskHandle , const char channel [], float64 data ); 
fcns.thunkname{fcnNum}='longuint64cstringdoubleThunk';fcns.name{fcnNum}='DAQmxSetAIDigFltrHighpassCutoffFreq'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'uint64', 'cstring', 'double'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxResetAIDigFltrHighpassCutoffFreq ( TaskHandle taskHandle , const char channel []); 
fcns.thunkname{fcnNum}='longuint64cstringThunk';fcns.name{fcnNum}='DAQmxResetAIDigFltrHighpassCutoffFreq'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'uint64', 'cstring'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxGetAIDigFltrBandpassCenterFreq ( TaskHandle taskHandle , const char channel [], float64 * data ); 
fcns.thunkname{fcnNum}='longuint64cstringvoidPtrThunk';fcns.name{fcnNum}='DAQmxGetAIDigFltrBandpassCenterFreq'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'uint64', 'cstring', 'doublePtr'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxSetAIDigFltrBandpassCenterFreq ( TaskHandle taskHandle , const char channel [], float64 data ); 
fcns.thunkname{fcnNum}='longuint64cstringdoubleThunk';fcns.name{fcnNum}='DAQmxSetAIDigFltrBandpassCenterFreq'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'uint64', 'cstring', 'double'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxResetAIDigFltrBandpassCenterFreq ( TaskHandle taskHandle , const char channel []); 
fcns.thunkname{fcnNum}='longuint64cstringThunk';fcns.name{fcnNum}='DAQmxResetAIDigFltrBandpassCenterFreq'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'uint64', 'cstring'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxGetAIDigFltrBandpassWidth ( TaskHandle taskHandle , const char channel [], float64 * data ); 
fcns.thunkname{fcnNum}='longuint64cstringvoidPtrThunk';fcns.name{fcnNum}='DAQmxGetAIDigFltrBandpassWidth'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'uint64', 'cstring', 'doublePtr'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxSetAIDigFltrBandpassWidth ( TaskHandle taskHandle , const char channel [], float64 data ); 
fcns.thunkname{fcnNum}='longuint64cstringdoubleThunk';fcns.name{fcnNum}='DAQmxSetAIDigFltrBandpassWidth'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'uint64', 'cstring', 'double'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxResetAIDigFltrBandpassWidth ( TaskHandle taskHandle , const char channel []); 
fcns.thunkname{fcnNum}='longuint64cstringThunk';fcns.name{fcnNum}='DAQmxResetAIDigFltrBandpassWidth'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'uint64', 'cstring'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxGetAIDigFltrNotchCenterFreq ( TaskHandle taskHandle , const char channel [], float64 * data ); 
fcns.thunkname{fcnNum}='longuint64cstringvoidPtrThunk';fcns.name{fcnNum}='DAQmxGetAIDigFltrNotchCenterFreq'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'uint64', 'cstring', 'doublePtr'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxSetAIDigFltrNotchCenterFreq ( TaskHandle taskHandle , const char channel [], float64 data ); 
fcns.thunkname{fcnNum}='longuint64cstringdoubleThunk';fcns.name{fcnNum}='DAQmxSetAIDigFltrNotchCenterFreq'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'uint64', 'cstring', 'double'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxResetAIDigFltrNotchCenterFreq ( TaskHandle taskHandle , const char channel []); 
fcns.thunkname{fcnNum}='longuint64cstringThunk';fcns.name{fcnNum}='DAQmxResetAIDigFltrNotchCenterFreq'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'uint64', 'cstring'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxGetAIDigFltrNotchWidth ( TaskHandle taskHandle , const char channel [], float64 * data ); 
fcns.thunkname{fcnNum}='longuint64cstringvoidPtrThunk';fcns.name{fcnNum}='DAQmxGetAIDigFltrNotchWidth'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'uint64', 'cstring', 'doublePtr'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxSetAIDigFltrNotchWidth ( TaskHandle taskHandle , const char channel [], float64 data ); 
fcns.thunkname{fcnNum}='longuint64cstringdoubleThunk';fcns.name{fcnNum}='DAQmxSetAIDigFltrNotchWidth'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'uint64', 'cstring', 'double'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxResetAIDigFltrNotchWidth ( TaskHandle taskHandle , const char channel []); 
fcns.thunkname{fcnNum}='longuint64cstringThunk';fcns.name{fcnNum}='DAQmxResetAIDigFltrNotchWidth'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'uint64', 'cstring'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxGetAIDigFltrCoeff ( TaskHandle taskHandle , const char channel [], float64 * data , uInt32 arraySizeInElements ); 
fcns.thunkname{fcnNum}='longuint64cstringvoidPtrulongThunk';fcns.name{fcnNum}='DAQmxGetAIDigFltrCoeff'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'uint64', 'cstring', 'doublePtr', 'ulong'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxSetAIDigFltrCoeff ( TaskHandle taskHandle , const char channel [], float64 * data , uInt32 arraySizeInElements ); 
fcns.thunkname{fcnNum}='longuint64cstringvoidPtrulongThunk';fcns.name{fcnNum}='DAQmxSetAIDigFltrCoeff'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'uint64', 'cstring', 'doublePtr', 'ulong'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxResetAIDigFltrCoeff ( TaskHandle taskHandle , const char channel []); 
fcns.thunkname{fcnNum}='longuint64cstringThunk';fcns.name{fcnNum}='DAQmxResetAIDigFltrCoeff'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'uint64', 'cstring'};fcnNum=fcnNum+1;
...
fcns.thunkname{fcnNum}='longuint64cstringvoidPtrThunk';fcns.name{fcnNum}='DAQmxGetAIFilterDelayUnits'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'uint64', 'cstring', 'longPtr'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxSetAIFilterDelayUnits ( TaskHandle taskHandle , const char channel [], int32 data ); 
fcns.thunkname{fcnNum}='longuint64cstringlongThunk';fcns.name{fcnNum}='DAQmxSetAIFilterDelayUnits'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'uint64', 'cstring', 'long'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxResetAIFilterDelayUnits ( TaskHandle taskHandle , const char channel []); 
fcns.thunkname{fcnNum}='longuint64cstringThunk';fcns.name{fcnNum}='DAQmxResetAIFilterDelayUnits'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'uint64', 'cstring'};fcnNum=fcnNum+1;
...
fcns.thunkname{fcnNum}='longuint64cstringvoidPtrThunk';fcns.name{fcnNum}='DAQmxGetAIFilterDelayAdjustment'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'uint64', 'cstring', 'doublePtr'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxSetAIFilterDelayAdjustment ( TaskHandle taskHandle , const char channel [], float64 data ); 
fcns.thunkname{fcnNum}='longuint64cstringdoubleThunk';fcns.name{fcnNum}='DAQmxSetAIFilterDelayAdjustment'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'uint64', 'cstring', 'double'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxResetAIFilterDelayAdjustment ( TaskHandle taskHandle , const char channel []); 
fcns.thunkname{fcnNum}='longuint64cstringThunk';fcns.name{fcnNum}='DAQmxResetAIFilterDelayAdjustment'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'uint64', 'cstring'};fcnNum=fcnNum+1;
...
fcns.thunkname{fcnNum}='longuint64cstringvoidPtrThunk';fcns.name{fcnNum}='DAQmxGetAOFilterDelay'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'uint64', 'cstring', 'doublePtr'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxSetAOFilterDelay ( TaskHandle taskHandle , const char channel [], float64 data ); 
fcns.thunkname{fcnNum}='longuint64cstringdoubleThunk';fcns.name{fcnNum}='DAQmxSetAOFilterDelay'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'uint64', 'cstring', 'double'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxResetAOFilterDelay ( TaskHandle taskHandle , const char channel []); 
fcns.thunkname{fcnNum}='longuint64cstringThunk';fcns.name{fcnNum}='DAQmxResetAOFilterDelay'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'uint64', 'cstring'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxGetAOFilterDelayUnits ( TaskHandle taskHandle , const char channel [], int32 * data ); 
fcns.thunkname{fcnNum}='longuint64cstringvoidPtrThunk';fcns.name{fcnNum}='DAQmxGetAOFilterDelayUnits'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'uint64', 'cstring', 'longPtr'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxSetAOFilterDelayUnits ( TaskHandle taskHandle , const char channel [], int32 data ); 
fcns.thunkname{fcnNum}='longuint64cstringlongThunk';fcns.name{fcnNum}='DAQmxSetAOFilterDelayUnits'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'uint64', 'cstring', 'long'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxResetAOFilterDelayUnits ( TaskHandle taskHandle , const char channel []); 
fcns.thunkname{fcnNum}='longuint64cstringThunk';fcns.name{fcnNum}='DAQmxResetAOFilterDelayUnits'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'uint64', 'cstring'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxGetAOFilterDelayAdjustment ( TaskHandle taskHandle , const char channel [], float64 * data ); 
fcns.thunkname{fcnNum}='longuint64cstringvoidPtrThunk';fcns.name{fcnNum}='DAQmxGetAOFilterDelayAdjustment'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'uint64', 'cstring', 'doublePtr'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxSetAOFilterDelayAdjustment ( TaskHandle taskHandle , const char channel [], float64 data ); 
fcns.thunkname{fcnNum}='longuint64cstringdoubleThunk';fcns.name{fcnNum}='DAQmxSetAOFilterDelayAdjustment'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'uint64', 'cstring', 'double'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxResetAOFilterDelayAdjustment ( TaskHandle taskHandle , const char channel []); 
fcns.thunkname{fcnNum}='longuint64cstringThunk';fcns.name{fcnNum}='DAQmxResetAOFilterDelayAdjustment'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'uint64', 'cstring'};fcnNum=fcnNum+1;
...
fcns.thunkname{fcnNum}='longuint64cstringvoidPtrThunk';fcns.name{fcnNum}='DAQmxGetCIFreqTermCfg'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'uint64', 'cstring', 'longPtr'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxSetCIFreqTermCfg ( TaskHandle taskHandle , const char channel [], int32 data ); 
fcns.thunkname{fcnNum}='longuint64cstringlongThunk';fcns.name{fcnNum}='DAQmxSetCIFreqTermCfg'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'uint64', 'cstring', 'long'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxResetCIFreqTermCfg ( TaskHandle taskHandle , const char channel []); 
fcns.thunkname{fcnNum}='longuint64cstringThunk';fcns.name{fcnNum}='DAQmxResetCIFreqTermCfg'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'uint64', 'cstring'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxGetCIFreqLogicLvlBehavior ( TaskHandle taskHandle , const char channel [], int32 * data ); 
fcns.thunkname{fcnNum}='longuint64cstringvoidPtrThunk';fcns.name{fcnNum}='DAQmxGetCIFreqLogicLvlBehavior'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'uint64', 'cstring', 'longPtr'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxSetCIFreqLogicLvlBehavior ( TaskHandle taskHandle , const char channel [], int32 data ); 
fcns.thunkname{fcnNum}='longuint64cstringlongThunk';fcns.name{fcnNum}='DAQmxSetCIFreqLogicLvlBehavior'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'uint64', 'cstring', 'long'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxResetCIFreqLogicLvlBehavior ( TaskHandle taskHandle , const char channel []); 
fcns.thunkname{fcnNum}='longuint64cstringThunk';fcns.name{fcnNum}='DAQmxResetCIFreqLogicLvlBehavior'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'uint64', 'cstring'};fcnNum=fcnNum+1;
...
fcns.thunkname{fcnNum}='longuint64cstringvoidPtrThunk';fcns.name{fcnNum}='DAQmxGetCIPeriodTermCfg'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'uint64', 'cstring', 'longPtr'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxSetCIPeriodTermCfg ( TaskHandle taskHandle , const char channel [], int32 data ); 
fcns.thunkname{fcnNum}='longuint64cstringlongThunk';fcns.name{fcnNum}='DAQmxSetCIPeriodTermCfg'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'uint64', 'cstring', 'long'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxResetCIPeriodTermCfg ( TaskHandle taskHandle , const char channel []); 
fcns.thunkname{fcnNum}='longuint64cstringThunk';fcns.name{fcnNum}='DAQmxResetCIPeriodTermCfg'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'uint64', 'cstring'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxGetCIPeriodLogicLvlBehavior ( TaskHandle taskHandle , const char channel [], int32 * data ); 
fcns.thunkname{fcnNum}='longuint64cstringvoidPtrThunk';fcns.name{fcnNum}='DAQmxGetCIPeriodLogicLvlBehavior'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'uint64', 'cstring', 'longPtr'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxSetCIPeriodLogicLvlBehavior ( TaskHandle taskHandle , const char channel [], int32 data ); 
fcns.thunkname{fcnNum}='longuint64cstringlongThunk';fcns.name{fcnNum}='DAQmxSetCIPeriodLogicLvlBehavior'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'uint64', 'cstring', 'long'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxResetCIPeriodLogicLvlBehavior ( TaskHandle taskHandle , const char channel []); 
fcns.thunkname{fcnNum}='longuint64cstringThunk';fcns.name{fcnNum}='DAQmxResetCIPeriodLogicLvlBehavior'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'uint64', 'cstring'};fcnNum=fcnNum+1;
...
fcns.thunkname{fcnNum}='longuint64cstringvoidPtrThunk';fcns.name{fcnNum}='DAQmxGetCICountEdgesTermCfg'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'uint64', 'cstring', 'longPtr'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxSetCICountEdgesTermCfg ( TaskHandle taskHandle , const char channel [], int32 data ); 
fcns.thunkname{fcnNum}='longuint64cstringlongThunk';fcns.name{fcnNum}='DAQmxSetCICountEdgesTermCfg'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'uint64', 'cstring', 'long'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxResetCICountEdgesTermCfg ( TaskHandle taskHandle , const char channel []); 
fcns.thunkname{fcnNum}='longuint64cstringThunk';fcns.name{fcnNum}='DAQmxResetCICountEdgesTermCfg'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'uint64', 'cstring'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxGetCICountEdgesLogicLvlBehavior ( TaskHandle taskHandle , const char channel [], int32 * data ); 
fcns.thunkname{fcnNum}='longuint64cstringvoidPtrThunk';fcns.name{fcnNum}='DAQmxGetCICountEdgesLogicLvlBehavior'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'uint64', 'cstring', 'longPtr'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxSetCICountEdgesLogicLvlBehavior ( TaskHandle taskHandle , const char channel [], int32 data ); 
fcns.thunkname{fcnNum}='longuint64cstringlongThunk';fcns.name{fcnNum}='DAQmxSetCICountEdgesLogicLvlBehavior'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'uint64', 'cstring', 'long'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxResetCICountEdgesLogicLvlBehavior ( TaskHandle taskHandle , const char channel []); 
fcns.thunkname{fcnNum}='longuint64cstringThunk';fcns.name{fcnNum}='DAQmxResetCICountEdgesLogicLvlBehavior'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'uint64', 'cstring'};fcnNum=fcnNum+1;
...
fcns.thunkname{fcnNum}='longuint64cstringvoidPtrThunk';fcns.name{fcnNum}='DAQmxGetCICountEdgesCountDirTermCfg'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'uint64', 'cstring', 'longPtr'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxSetCICountEdgesCountDirTermCfg ( TaskHandle taskHandle , const char channel [], int32 data ); 
fcns.thunkname{fcnNum}='longuint64cstringlongThunk';fcns.name{fcnNum}='DAQmxSetCICountEdgesCountDirTermCfg'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'uint64', 'cstring', 'long'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxResetCICountEdgesCountDirTermCfg ( TaskHandle taskHandle , const char channel []); 
fcns.thunkname{fcnNum}='longuint64cstringThunk';fcns.name{fcnNum}='DAQmxResetCICountEdgesCountDirTermCfg'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'uint64', 'cstring'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxGetCICountEdgesCountDirLogicLvlBehavior ( TaskHandle taskHandle , const char channel [], int32 * data ); 
fcns.thunkname{fcnNum}='longuint64cstringvoidPtrThunk';fcns.name{fcnNum}='DAQmxGetCICountEdgesCountDirLogicLvlBehavior'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'uint64', 'cstring', 'longPtr'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxSetCICountEdgesCountDirLogicLvlBehavior ( TaskHandle taskHandle , const char channel [], int32 data ); 
fcns.thunkname{fcnNum}='longuint64cstringlongThunk';fcns.name{fcnNum}='DAQmxSetCICountEdgesCountDirLogicLvlBehavior'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'uint64', 'cstring', 'long'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxResetCICountEdgesCountDirLogicLvlBehavior ( TaskHandle taskHandle , const char channel []); 
fcns.thunkname{fcnNum}='longuint64cstringThunk';fcns.name{fcnNum}='DAQmxResetCICountEdgesCountDirLogicLvlBehavior'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'uint64', 'cstring'};fcnNum=fcnNum+1;
...
fcns.thunkname{fcnNum}='longuint64cstringvoidPtrThunk';fcns.name{fcnNum}='DAQmxGetCICountEdgesCountResetTermCfg'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'uint64', 'cstring', 'longPtr'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxSetCICountEdgesCountResetTermCfg ( TaskHandle taskHandle , const char channel [], int32 data ); 
fcns.thunkname{fcnNum}='longuint64cstringlongThunk';fcns.name{fcnNum}='DAQmxSetCICountEdgesCountResetTermCfg'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'uint64', 'cstring', 'long'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxResetCICountEdgesCountResetTermCfg ( TaskHandle taskHandle , const char channel []); 
fcns.thunkname{fcnNum}='longuint64cstringThunk';fcns.name{fcnNum}='DAQmxResetCICountEdgesCountResetTermCfg'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'uint64', 'cstring'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxGetCICountEdgesCountResetLogicLvlBehavior ( TaskHandle taskHandle , const char channel [], int32 * data ); 
fcns.thunkname{fcnNum}='longuint64cstringvoidPtrThunk';fcns.name{fcnNum}='DAQmxGetCICountEdgesCountResetLogicLvlBehavior'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'uint64', 'cstring', 'longPtr'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxSetCICountEdgesCountResetLogicLvlBehavior ( TaskHandle taskHandle , const char channel [], int32 data ); 
fcns.thunkname{fcnNum}='longuint64cstringlongThunk';fcns.name{fcnNum}='DAQmxSetCICountEdgesCountResetLogicLvlBehavior'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'uint64', 'cstring', 'long'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxResetCICountEdgesCountResetLogicLvlBehavior ( TaskHandle taskHandle , const char channel []); 
fcns.thunkname{fcnNum}='longuint64cstringThunk';fcns.name{fcnNum}='DAQmxResetCICountEdgesCountResetLogicLvlBehavior'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'uint64', 'cstring'};fcnNum=fcnNum+1;
...
fcns.thunkname{fcnNum}='longuint64cstringcstringulongThunk';fcns.name{fcnNum}='DAQmxGetCIDutyCycleTerm'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'uint64', 'cstring', 'cstring', 'ulong'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxSetCIDutyCycleTerm ( TaskHandle taskHandle , const char channel [], const char * data ); 
fcns.thunkname{fcnNum}='longuint64cstringcstringThunk';fcns.name{fcnNum}='DAQmxSetCIDutyCycleTerm'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'uint64', 'cstring', 'cstring'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxResetCIDutyCycleTerm ( TaskHandle taskHandle , const char channel []); 
fcns.thunkname{fcnNum}='longuint64cstringThunk';fcns.name{fcnNum}='DAQmxResetCIDutyCycleTerm'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'uint64', 'cstring'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxGetCIDutyCycleTermCfg ( TaskHandle taskHandle , const char channel [], int32 * data ); 
fcns.thunkname{fcnNum}='longuint64cstringvoidPtrThunk';fcns.name{fcnNum}='DAQmxGetCIDutyCycleTermCfg'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'uint64', 'cstring', 'longPtr'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxSetCIDutyCycleTermCfg ( TaskHandle taskHandle , const char channel [], int32 data ); 
fcns.thunkname{fcnNum}='longuint64cstringlongThunk';fcns.name{fcnNum}='DAQmxSetCIDutyCycleTermCfg'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'uint64', 'cstring', 'long'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxResetCIDutyCycleTermCfg ( TaskHandle taskHandle , const char channel []); 
fcns.thunkname{fcnNum}='longuint64cstringThunk';fcns.name{fcnNum}='DAQmxResetCIDutyCycleTermCfg'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'uint64', 'cstring'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxGetCIDutyCycleLogicLvlBehavior ( TaskHandle taskHandle , const char channel [], int32 * data ); 
fcns.thunkname{fcnNum}='longuint64cstringvoidPtrThunk';fcns.name{fcnNum}='DAQmxGetCIDutyCycleLogicLvlBehavior'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'uint64', 'cstring', 'longPtr'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxSetCIDutyCycleLogicLvlBehavior ( TaskHandle taskHandle , const char channel [], int32 data ); 
fcns.thunkname{fcnNum}='longuint64cstringlongThunk';fcns.name{fcnNum}='DAQmxSetCIDutyCycleLogicLvlBehavior'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'uint64', 'cstring', 'long'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxResetCIDutyCycleLogicLvlBehavior ( TaskHandle taskHandle , const char channel []); 
fcns.thunkname{fcnNum}='longuint64cstringThunk';fcns.name{fcnNum}='DAQmxResetCIDutyCycleLogicLvlBehavior'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'uint64', 'cstring'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxGetCIDutyCycleDigFltrEnable ( TaskHandle taskHandle , const char channel [], bool32 * data ); 
fcns.thunkname{fcnNum}='longuint64cstringvoidPtrThunk';fcns.name{fcnNum}='DAQmxGetCIDutyCycleDigFltrEnable'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'uint64', 'cstring', 'ulongPtr'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxSetCIDutyCycleDigFltrEnable ( TaskHandle taskHandle , const char channel [], bool32 data ); 
fcns.thunkname{fcnNum}='longuint64cstringulongThunk';fcns.name{fcnNum}='DAQmxSetCIDutyCycleDigFltrEnable'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'uint64', 'cstring', 'ulong'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxResetCIDutyCycleDigFltrEnable ( TaskHandle taskHandle , const char channel []); 
fcns.thunkname{fcnNum}='longuint64cstringThunk';fcns.name{fcnNum}='DAQmxResetCIDutyCycleDigFltrEnable'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'uint64', 'cstring'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxGetCIDutyCycleDigFltrMinPulseWidth ( TaskHandle taskHandle , const char channel [], float64 * data ); 
fcns.thunkname{fcnNum}='longuint64cstringvoidPtrThunk';fcns.name{fcnNum}='DAQmxGetCIDutyCycleDigFltrMinPulseWidth'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'uint64', 'cstring', 'doublePtr'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxSetCIDutyCycleDigFltrMinPulseWidth ( TaskHandle taskHandle , const char channel [], float64 data ); 
fcns.thunkname{fcnNum}='longuint64cstringdoubleThunk';fcns.name{fcnNum}='DAQmxSetCIDutyCycleDigFltrMinPulseWidth'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'uint64', 'cstring', 'double'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxResetCIDutyCycleDigFltrMinPulseWidth ( TaskHandle taskHandle , const char channel []); 
fcns.thunkname{fcnNum}='longuint64cstringThunk';fcns.name{fcnNum}='DAQmxResetCIDutyCycleDigFltrMinPulseWidth'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'uint64', 'cstring'};fcnNum=fcnNum+1;
...
fcns.thunkname{fcnNum}='longuint64cstringcstringulongThunk';fcns.name{fcnNum}='DAQmxGetCIDutyCycleDigFltrTimebaseSrc'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'uint64', 'cstring', 'cstring', 'ulong'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxSetCIDutyCycleDigFltrTimebaseSrc ( TaskHandle taskHandle , const char channel [], const char * data ); 
fcns.thunkname{fcnNum}='longuint64cstringcstringThunk';fcns.name{fcnNum}='DAQmxSetCIDutyCycleDigFltrTimebaseSrc'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'uint64', 'cstring', 'cstring'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxResetCIDutyCycleDigFltrTimebaseSrc ( TaskHandle taskHandle , const char channel []); 
fcns.thunkname{fcnNum}='longuint64cstringThunk';fcns.name{fcnNum}='DAQmxResetCIDutyCycleDigFltrTimebaseSrc'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'uint64', 'cstring'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxGetCIDutyCycleDigFltrTimebaseRate ( TaskHandle taskHandle , const char channel [], float64 * data ); 
fcns.thunkname{fcnNum}='longuint64cstringvoidPtrThunk';fcns.name{fcnNum}='DAQmxGetCIDutyCycleDigFltrTimebaseRate'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'uint64', 'cstring', 'doublePtr'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxSetCIDutyCycleDigFltrTimebaseRate ( TaskHandle taskHandle , const char channel [], float64 data ); 
fcns.thunkname{fcnNum}='longuint64cstringdoubleThunk';fcns.name{fcnNum}='DAQmxSetCIDutyCycleDigFltrTimebaseRate'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'uint64', 'cstring', 'double'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxResetCIDutyCycleDigFltrTimebaseRate ( TaskHandle taskHandle , const char channel []); 
fcns.thunkname{fcnNum}='longuint64cstringThunk';fcns.name{fcnNum}='DAQmxResetCIDutyCycleDigFltrTimebaseRate'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'uint64', 'cstring'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxGetCIDutyCycleStartingEdge ( TaskHandle taskHandle , const char channel [], int32 * data ); 
fcns.thunkname{fcnNum}='longuint64cstringvoidPtrThunk';fcns.name{fcnNum}='DAQmxGetCIDutyCycleStartingEdge'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'uint64', 'cstring', 'longPtr'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxSetCIDutyCycleStartingEdge ( TaskHandle taskHandle , const char channel [], int32 data ); 
fcns.thunkname{fcnNum}='longuint64cstringlongThunk';fcns.name{fcnNum}='DAQmxSetCIDutyCycleStartingEdge'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'uint64', 'cstring', 'long'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxResetCIDutyCycleStartingEdge ( TaskHandle taskHandle , const char channel []); 
fcns.thunkname{fcnNum}='longuint64cstringThunk';fcns.name{fcnNum}='DAQmxResetCIDutyCycleStartingEdge'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'uint64', 'cstring'};fcnNum=fcnNum+1;
...
fcns.thunkname{fcnNum}='longuint64cstringvoidPtrThunk';fcns.name{fcnNum}='DAQmxGetCIEncoderAInputTermCfg'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'uint64', 'cstring', 'longPtr'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxSetCIEncoderAInputTermCfg ( TaskHandle taskHandle , const char channel [], int32 data ); 
fcns.thunkname{fcnNum}='longuint64cstringlongThunk';fcns.name{fcnNum}='DAQmxSetCIEncoderAInputTermCfg'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'uint64', 'cstring', 'long'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxResetCIEncoderAInputTermCfg ( TaskHandle taskHandle , const char channel []); 
fcns.thunkname{fcnNum}='longuint64cstringThunk';fcns.name{fcnNum}='DAQmxResetCIEncoderAInputTermCfg'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'uint64', 'cstring'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxGetCIEncoderAInputLogicLvlBehavior ( TaskHandle taskHandle , const char channel [], int32 * data ); 
fcns.thunkname{fcnNum}='longuint64cstringvoidPtrThunk';fcns.name{fcnNum}='DAQmxGetCIEncoderAInputLogicLvlBehavior'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'uint64', 'cstring', 'longPtr'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxSetCIEncoderAInputLogicLvlBehavior ( TaskHandle taskHandle , const char channel [], int32 data ); 
fcns.thunkname{fcnNum}='longuint64cstringlongThunk';fcns.name{fcnNum}='DAQmxSetCIEncoderAInputLogicLvlBehavior'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'uint64', 'cstring', 'long'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxResetCIEncoderAInputLogicLvlBehavior ( TaskHandle taskHandle , const char channel []); 
fcns.thunkname{fcnNum}='longuint64cstringThunk';fcns.name{fcnNum}='DAQmxResetCIEncoderAInputLogicLvlBehavior'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'uint64', 'cstring'};fcnNum=fcnNum+1;
...
fcns.thunkname{fcnNum}='longuint64cstringvoidPtrThunk';fcns.name{fcnNum}='DAQmxGetCIEncoderBInputTermCfg'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'uint64', 'cstring', 'longPtr'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxSetCIEncoderBInputTermCfg ( TaskHandle taskHandle , const char channel [], int32 data ); 
fcns.thunkname{fcnNum}='longuint64cstringlongThunk';fcns.name{fcnNum}='DAQmxSetCIEncoderBInputTermCfg'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'uint64', 'cstring', 'long'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxResetCIEncoderBInputTermCfg ( TaskHandle taskHandle , const char channel []); 
fcns.thunkname{fcnNum}='longuint64cstringThunk';fcns.name{fcnNum}='DAQmxResetCIEncoderBInputTermCfg'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'uint64', 'cstring'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxGetCIEncoderBInputLogicLvlBehavior ( TaskHandle taskHandle , const char channel [], int32 * data ); 
fcns.thunkname{fcnNum}='longuint64cstringvoidPtrThunk';fcns.name{fcnNum}='DAQmxGetCIEncoderBInputLogicLvlBehavior'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'uint64', 'cstring', 'longPtr'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxSetCIEncoderBInputLogicLvlBehavior ( TaskHandle taskHandle , const char channel [], int32 data ); 
fcns.thunkname{fcnNum}='longuint64cstringlongThunk';fcns.name{fcnNum}='DAQmxSetCIEncoderBInputLogicLvlBehavior'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'uint64', 'cstring', 'long'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxResetCIEncoderBInputLogicLvlBehavior ( TaskHandle taskHandle , const char channel []); 
fcns.thunkname{fcnNum}='longuint64cstringThunk';fcns.name{fcnNum}='DAQmxResetCIEncoderBInputLogicLvlBehavior'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'uint64', 'cstring'};fcnNum=fcnNum+1;
...
fcns.thunkname{fcnNum}='longuint64cstringvoidPtrThunk';fcns.name{fcnNum}='DAQmxGetCIEncoderZInputTermCfg'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'uint64', 'cstring', 'longPtr'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxSetCIEncoderZInputTermCfg ( TaskHandle taskHandle , const char channel [], int32 data ); 
fcns.thunkname{fcnNum}='longuint64cstringlongThunk';fcns.name{fcnNum}='DAQmxSetCIEncoderZInputTermCfg'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'uint64', 'cstring', 'long'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxResetCIEncoderZInputTermCfg ( TaskHandle taskHandle , const char channel []); 
fcns.thunkname{fcnNum}='longuint64cstringThunk';fcns.name{fcnNum}='DAQmxResetCIEncoderZInputTermCfg'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'uint64', 'cstring'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxGetCIEncoderZInputLogicLvlBehavior ( TaskHandle taskHandle , const char channel [], int32 * data ); 
fcns.thunkname{fcnNum}='longuint64cstringvoidPtrThunk';fcns.name{fcnNum}='DAQmxGetCIEncoderZInputLogicLvlBehavior'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'uint64', 'cstring', 'longPtr'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxSetCIEncoderZInputLogicLvlBehavior ( TaskHandle taskHandle , const char channel [], int32 data ); 
fcns.thunkname{fcnNum}='longuint64cstringlongThunk';fcns.name{fcnNum}='DAQmxSetCIEncoderZInputLogicLvlBehavior'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'uint64', 'cstring', 'long'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxResetCIEncoderZInputLogicLvlBehavior ( TaskHandle taskHandle , const char channel []); 
fcns.thunkname{fcnNum}='longuint64cstringThunk';fcns.name{fcnNum}='DAQmxResetCIEncoderZInputLogicLvlBehavior'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'uint64', 'cstring'};fcnNum=fcnNum+1;
...
fcns.thunkname{fcnNum}='longuint64cstringvoidPtrThunk';fcns.name{fcnNum}='DAQmxGetCIPulseWidthTermCfg'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'uint64', 'cstring', 'longPtr'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxSetCIPulseWidthTermCfg ( TaskHandle taskHandle , const char channel [], int32 data ); 
fcns.thunkname{fcnNum}='longuint64cstringlongThunk';fcns.name{fcnNum}='DAQmxSetCIPulseWidthTermCfg'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'uint64', 'cstring', 'long'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxResetCIPulseWidthTermCfg ( TaskHandle taskHandle , const char channel []); 
fcns.thunkname{fcnNum}='longuint64cstringThunk';fcns.name{fcnNum}='DAQmxResetCIPulseWidthTermCfg'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'uint64', 'cstring'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxGetCIPulseWidthLogicLvlBehavior ( TaskHandle taskHandle , const char channel [], int32 * data ); 
fcns.thunkname{fcnNum}='longuint64cstringvoidPtrThunk';fcns.name{fcnNum}='DAQmxGetCIPulseWidthLogicLvlBehavior'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'uint64', 'cstring', 'longPtr'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxSetCIPulseWidthLogicLvlBehavior ( TaskHandle taskHandle , const char channel [], int32 data ); 
fcns.thunkname{fcnNum}='longuint64cstringlongThunk';fcns.name{fcnNum}='DAQmxSetCIPulseWidthLogicLvlBehavior'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'uint64', 'cstring', 'long'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxResetCIPulseWidthLogicLvlBehavior ( TaskHandle taskHandle , const char channel []); 
fcns.thunkname{fcnNum}='longuint64cstringThunk';fcns.name{fcnNum}='DAQmxResetCIPulseWidthLogicLvlBehavior'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'uint64', 'cstring'};fcnNum=fcnNum+1;
...
fcns.thunkname{fcnNum}='longuint64cstringvoidPtrThunk';fcns.name{fcnNum}='DAQmxGetCITwoEdgeSepFirstTermCfg'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'uint64', 'cstring', 'longPtr'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxSetCITwoEdgeSepFirstTermCfg ( TaskHandle taskHandle , const char channel [], int32 data ); 
fcns.thunkname{fcnNum}='longuint64cstringlongThunk';fcns.name{fcnNum}='DAQmxSetCITwoEdgeSepFirstTermCfg'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'uint64', 'cstring', 'long'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxResetCITwoEdgeSepFirstTermCfg ( TaskHandle taskHandle , const char channel []); 
fcns.thunkname{fcnNum}='longuint64cstringThunk';fcns.name{fcnNum}='DAQmxResetCITwoEdgeSepFirstTermCfg'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'uint64', 'cstring'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxGetCITwoEdgeSepFirstLogicLvlBehavior ( TaskHandle taskHandle , const char channel [], int32 * data ); 
fcns.thunkname{fcnNum}='longuint64cstringvoidPtrThunk';fcns.name{fcnNum}='DAQmxGetCITwoEdgeSepFirstLogicLvlBehavior'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'uint64', 'cstring', 'longPtr'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxSetCITwoEdgeSepFirstLogicLvlBehavior ( TaskHandle taskHandle , const char channel [], int32 data ); 
fcns.thunkname{fcnNum}='longuint64cstringlongThunk';fcns.name{fcnNum}='DAQmxSetCITwoEdgeSepFirstLogicLvlBehavior'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'uint64', 'cstring', 'long'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxResetCITwoEdgeSepFirstLogicLvlBehavior ( TaskHandle taskHandle , const char channel []); 
fcns.thunkname{fcnNum}='longuint64cstringThunk';fcns.name{fcnNum}='DAQmxResetCITwoEdgeSepFirstLogicLvlBehavior'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'uint64', 'cstring'};fcnNum=fcnNum+1;
...
fcns.thunkname{fcnNum}='longuint64cstringvoidPtrThunk';fcns.name{fcnNum}='DAQmxGetCITwoEdgeSepSecondTermCfg'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'uint64', 'cstring', 'longPtr'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxSetCITwoEdgeSepSecondTermCfg ( TaskHandle taskHandle , const char channel [], int32 data ); 
fcns.thunkname{fcnNum}='longuint64cstringlongThunk';fcns.name{fcnNum}='DAQmxSetCITwoEdgeSepSecondTermCfg'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'uint64', 'cstring', 'long'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxResetCITwoEdgeSepSecondTermCfg ( TaskHandle taskHandle , const char channel []); 
fcns.thunkname{fcnNum}='longuint64cstringThunk';fcns.name{fcnNum}='DAQmxResetCITwoEdgeSepSecondTermCfg'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'uint64', 'cstring'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxGetCITwoEdgeSepSecondLogicLvlBehavior ( TaskHandle taskHandle , const char channel [], int32 * data ); 
fcns.thunkname{fcnNum}='longuint64cstringvoidPtrThunk';fcns.name{fcnNum}='DAQmxGetCITwoEdgeSepSecondLogicLvlBehavior'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'uint64', 'cstring', 'longPtr'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxSetCITwoEdgeSepSecondLogicLvlBehavior ( TaskHandle taskHandle , const char channel [], int32 data ); 
fcns.thunkname{fcnNum}='longuint64cstringlongThunk';fcns.name{fcnNum}='DAQmxSetCITwoEdgeSepSecondLogicLvlBehavior'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'uint64', 'cstring', 'long'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxResetCITwoEdgeSepSecondLogicLvlBehavior ( TaskHandle taskHandle , const char channel []); 
fcns.thunkname{fcnNum}='longuint64cstringThunk';fcns.name{fcnNum}='DAQmxResetCITwoEdgeSepSecondLogicLvlBehavior'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'uint64', 'cstring'};fcnNum=fcnNum+1;
...
fcns.thunkname{fcnNum}='longuint64cstringvoidPtrThunk';fcns.name{fcnNum}='DAQmxGetCISemiPeriodTermCfg'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'uint64', 'cstring', 'longPtr'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxSetCISemiPeriodTermCfg ( TaskHandle taskHandle , const char channel [], int32 data ); 
fcns.thunkname{fcnNum}='longuint64cstringlongThunk';fcns.name{fcnNum}='DAQmxSetCISemiPeriodTermCfg'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'uint64', 'cstring', 'long'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxResetCISemiPeriodTermCfg ( TaskHandle taskHandle , const char channel []); 
fcns.thunkname{fcnNum}='longuint64cstringThunk';fcns.name{fcnNum}='DAQmxResetCISemiPeriodTermCfg'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'uint64', 'cstring'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxGetCISemiPeriodLogicLvlBehavior ( TaskHandle taskHandle , const char channel [], int32 * data ); 
fcns.thunkname{fcnNum}='longuint64cstringvoidPtrThunk';fcns.name{fcnNum}='DAQmxGetCISemiPeriodLogicLvlBehavior'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'uint64', 'cstring', 'longPtr'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxSetCISemiPeriodLogicLvlBehavior ( TaskHandle taskHandle , const char channel [], int32 data ); 
fcns.thunkname{fcnNum}='longuint64cstringlongThunk';fcns.name{fcnNum}='DAQmxSetCISemiPeriodLogicLvlBehavior'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'uint64', 'cstring', 'long'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxResetCISemiPeriodLogicLvlBehavior ( TaskHandle taskHandle , const char channel []); 
fcns.thunkname{fcnNum}='longuint64cstringThunk';fcns.name{fcnNum}='DAQmxResetCISemiPeriodLogicLvlBehavior'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'uint64', 'cstring'};fcnNum=fcnNum+1;
...
fcns.thunkname{fcnNum}='longuint64cstringvoidPtrThunk';fcns.name{fcnNum}='DAQmxGetCIPulseFreqTermCfg'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'uint64', 'cstring', 'longPtr'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxSetCIPulseFreqTermCfg ( TaskHandle taskHandle , const char channel [], int32 data ); 
fcns.thunkname{fcnNum}='longuint64cstringlongThunk';fcns.name{fcnNum}='DAQmxSetCIPulseFreqTermCfg'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'uint64', 'cstring', 'long'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxResetCIPulseFreqTermCfg ( TaskHandle taskHandle , const char channel []); 
fcns.thunkname{fcnNum}='longuint64cstringThunk';fcns.name{fcnNum}='DAQmxResetCIPulseFreqTermCfg'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'uint64', 'cstring'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxGetCIPulseFreqLogicLvlBehavior ( TaskHandle taskHandle , const char channel [], int32 * data ); 
fcns.thunkname{fcnNum}='longuint64cstringvoidPtrThunk';fcns.name{fcnNum}='DAQmxGetCIPulseFreqLogicLvlBehavior'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'uint64', 'cstring', 'longPtr'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxSetCIPulseFreqLogicLvlBehavior ( TaskHandle taskHandle , const char channel [], int32 data ); 
fcns.thunkname{fcnNum}='longuint64cstringlongThunk';fcns.name{fcnNum}='DAQmxSetCIPulseFreqLogicLvlBehavior'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'uint64', 'cstring', 'long'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxResetCIPulseFreqLogicLvlBehavior ( TaskHandle taskHandle , const char channel []); 
fcns.thunkname{fcnNum}='longuint64cstringThunk';fcns.name{fcnNum}='DAQmxResetCIPulseFreqLogicLvlBehavior'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'uint64', 'cstring'};fcnNum=fcnNum+1;
...
fcns.thunkname{fcnNum}='longuint64cstringvoidPtrThunk';fcns.name{fcnNum}='DAQmxGetCIPulseTimeTermCfg'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'uint64', 'cstring', 'longPtr'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxSetCIPulseTimeTermCfg ( TaskHandle taskHandle , const char channel [], int32 data ); 
fcns.thunkname{fcnNum}='longuint64cstringlongThunk';fcns.name{fcnNum}='DAQmxSetCIPulseTimeTermCfg'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'uint64', 'cstring', 'long'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxResetCIPulseTimeTermCfg ( TaskHandle taskHandle , const char channel []); 
fcns.thunkname{fcnNum}='longuint64cstringThunk';fcns.name{fcnNum}='DAQmxResetCIPulseTimeTermCfg'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'uint64', 'cstring'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxGetCIPulseTimeLogicLvlBehavior ( TaskHandle taskHandle , const char channel [], int32 * data ); 
fcns.thunkname{fcnNum}='longuint64cstringvoidPtrThunk';fcns.name{fcnNum}='DAQmxGetCIPulseTimeLogicLvlBehavior'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'uint64', 'cstring', 'longPtr'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxSetCIPulseTimeLogicLvlBehavior ( TaskHandle taskHandle , const char channel [], int32 data ); 
fcns.thunkname{fcnNum}='longuint64cstringlongThunk';fcns.name{fcnNum}='DAQmxSetCIPulseTimeLogicLvlBehavior'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'uint64', 'cstring', 'long'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxResetCIPulseTimeLogicLvlBehavior ( TaskHandle taskHandle , const char channel []); 
fcns.thunkname{fcnNum}='longuint64cstringThunk';fcns.name{fcnNum}='DAQmxResetCIPulseTimeLogicLvlBehavior'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'uint64', 'cstring'};fcnNum=fcnNum+1;
...
fcns.thunkname{fcnNum}='longuint64cstringvoidPtrThunk';fcns.name{fcnNum}='DAQmxGetCIPulseTicksTermCfg'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'uint64', 'cstring', 'longPtr'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxSetCIPulseTicksTermCfg ( TaskHandle taskHandle , const char channel [], int32 data ); 
fcns.thunkname{fcnNum}='longuint64cstringlongThunk';fcns.name{fcnNum}='DAQmxSetCIPulseTicksTermCfg'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'uint64', 'cstring', 'long'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxResetCIPulseTicksTermCfg ( TaskHandle taskHandle , const char channel []); 
fcns.thunkname{fcnNum}='longuint64cstringThunk';fcns.name{fcnNum}='DAQmxResetCIPulseTicksTermCfg'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'uint64', 'cstring'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxGetCIPulseTicksLogicLvlBehavior ( TaskHandle taskHandle , const char channel [], int32 * data ); 
fcns.thunkname{fcnNum}='longuint64cstringvoidPtrThunk';fcns.name{fcnNum}='DAQmxGetCIPulseTicksLogicLvlBehavior'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'uint64', 'cstring', 'longPtr'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxSetCIPulseTicksLogicLvlBehavior ( TaskHandle taskHandle , const char channel [], int32 data ); 
fcns.thunkname{fcnNum}='longuint64cstringlongThunk';fcns.name{fcnNum}='DAQmxSetCIPulseTicksLogicLvlBehavior'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'uint64', 'cstring', 'long'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxResetCIPulseTicksLogicLvlBehavior ( TaskHandle taskHandle , const char channel []); 
fcns.thunkname{fcnNum}='longuint64cstringThunk';fcns.name{fcnNum}='DAQmxResetCIPulseTicksLogicLvlBehavior'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'uint64', 'cstring'};fcnNum=fcnNum+1;
...
fcns.thunkname{fcnNum}='longuint64cstringvoidPtrThunk';fcns.name{fcnNum}='DAQmxGetCIThreshVoltage'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'uint64', 'cstring', 'doublePtr'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxSetCIThreshVoltage ( TaskHandle taskHandle , const char channel [], float64 data ); 
fcns.thunkname{fcnNum}='longuint64cstringdoubleThunk';fcns.name{fcnNum}='DAQmxSetCIThreshVoltage'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'uint64', 'cstring', 'double'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxResetCIThreshVoltage ( TaskHandle taskHandle , const char channel []); 
fcns.thunkname{fcnNum}='longuint64cstringThunk';fcns.name{fcnNum}='DAQmxResetCIThreshVoltage'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'uint64', 'cstring'};fcnNum=fcnNum+1;
...
fcns.thunkname{fcnNum}='longuint64cstringvoidPtrThunk';fcns.name{fcnNum}='DAQmxGetCISampClkOverrunBehavior'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'uint64', 'cstring', 'longPtr'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxSetCISampClkOverrunBehavior ( TaskHandle taskHandle , const char channel [], int32 data ); 
fcns.thunkname{fcnNum}='longuint64cstringlongThunk';fcns.name{fcnNum}='DAQmxSetCISampClkOverrunBehavior'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'uint64', 'cstring', 'long'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxResetCISampClkOverrunBehavior ( TaskHandle taskHandle , const char channel []); 
fcns.thunkname{fcnNum}='longuint64cstringThunk';fcns.name{fcnNum}='DAQmxResetCISampClkOverrunBehavior'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'uint64', 'cstring'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxGetCISampClkOverrunSentinelVal ( TaskHandle taskHandle , const char channel [], int32 * data ); 
fcns.thunkname{fcnNum}='longuint64cstringvoidPtrThunk';fcns.name{fcnNum}='DAQmxGetCISampClkOverrunSentinelVal'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'uint64', 'cstring', 'longPtr'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxSetCISampClkOverrunSentinelVal ( TaskHandle taskHandle , const char channel [], int32 data ); 
fcns.thunkname{fcnNum}='longuint64cstringlongThunk';fcns.name{fcnNum}='DAQmxSetCISampClkOverrunSentinelVal'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'uint64', 'cstring', 'long'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxResetCISampClkOverrunSentinelVal ( TaskHandle taskHandle , const char channel []); 
fcns.thunkname{fcnNum}='longuint64cstringThunk';fcns.name{fcnNum}='DAQmxResetCISampClkOverrunSentinelVal'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'uint64', 'cstring'};fcnNum=fcnNum+1;
...
fcns.thunkname{fcnNum}='longuint64cstringvoidPtrThunk';fcns.name{fcnNum}='DAQmxGetCIMaxMeasPeriod'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'uint64', 'cstring', 'doublePtr'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxSetCIMaxMeasPeriod ( TaskHandle taskHandle , const char channel [], float64 data ); 
fcns.thunkname{fcnNum}='longuint64cstringdoubleThunk';fcns.name{fcnNum}='DAQmxSetCIMaxMeasPeriod'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'uint64', 'cstring', 'double'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxResetCIMaxMeasPeriod ( TaskHandle taskHandle , const char channel []); 
fcns.thunkname{fcnNum}='longuint64cstringThunk';fcns.name{fcnNum}='DAQmxResetCIMaxMeasPeriod'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'uint64', 'cstring'};fcnNum=fcnNum+1;
...
fcns.thunkname{fcnNum}='longcstringvoidPtrulongThunk';fcns.name{fcnNum}='DAQmxGetDevAIDigFltrLowpassCutoffFreqDiscreteVals'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'cstring', 'doublePtr', 'ulong'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxGetDevAIDigFltrLowpassCutoffFreqRangeVals ( const char device [], float64 * data , uInt32 arraySizeInElements ); 
fcns.thunkname{fcnNum}='longcstringvoidPtrulongThunk';fcns.name{fcnNum}='DAQmxGetDevAIDigFltrLowpassCutoffFreqRangeVals'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'cstring', 'doublePtr', 'ulong'};fcnNum=fcnNum+1;
...
fcns.thunkname{fcnNum}='longuint64voidPtrThunk';fcns.name{fcnNum}='DAQmxGetReadExcitFaultChansExist'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'uint64', 'ulongPtr'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxGetReadExcitFaultChans ( TaskHandle taskHandle , char * data , uInt32 bufferSize ); 
fcns.thunkname{fcnNum}='longuint64cstringulongThunk';fcns.name{fcnNum}='DAQmxGetReadExcitFaultChans'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'uint64', 'cstring', 'ulong'};fcnNum=fcnNum+1;
...
fcns.thunkname{fcnNum}='longuint64voidPtrThunk';fcns.name{fcnNum}='DAQmxGetReadOvertemperatureChansExist'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'uint64', 'ulongPtr'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxGetReadOvertemperatureChans ( TaskHandle taskHandle , char * data , uInt32 bufferSize ); 
fcns.thunkname{fcnNum}='longuint64cstringulongThunk';fcns.name{fcnNum}='DAQmxGetReadOvertemperatureChans'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'uint64', 'cstring', 'ulong'};fcnNum=fcnNum+1;
...
fcns.thunkname{fcnNum}='longuint64voidPtrThunk';fcns.name{fcnNum}='DAQmxGetTimingSyncPulseForce'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'uint64', 'ulongPtr'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxSetTimingSyncPulseForce ( TaskHandle taskHandle , bool32 data ); 
fcns.thunkname{fcnNum}='longuint64ulongThunk';fcns.name{fcnNum}='DAQmxSetTimingSyncPulseForce'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'uint64', 'ulong'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxResetTimingSyncPulseForce ( TaskHandle taskHandle ); 
fcns.thunkname{fcnNum}='longuint64Thunk';fcns.name{fcnNum}='DAQmxResetTimingSyncPulseForce'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'uint64'};fcnNum=fcnNum+1;
...
fcns.thunkname{fcnNum}='longuint64cstringulongThunk';fcns.name{fcnNum}='DAQmxGetWriteOvertemperatureChans'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'uint64', 'cstring', 'ulong'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxGetWriteExternalOvervoltageChansExist ( TaskHandle taskHandle , bool32 * data ); 
fcns.thunkname{fcnNum}='longuint64voidPtrThunk';fcns.name{fcnNum}='DAQmxGetWriteExternalOvervoltageChansExist'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'uint64', 'ulongPtr'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxGetWriteExternalOvervoltageChans ( TaskHandle taskHandle , char * data , uInt32 bufferSize ); 
fcns.thunkname{fcnNum}='longuint64cstringulongThunk';fcns.name{fcnNum}='DAQmxGetWriteExternalOvervoltageChans'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'uint64', 'cstring', 'ulong'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxGetWriteOverloadedChansExist ( TaskHandle taskHandle , bool32 * data ); 
fcns.thunkname{fcnNum}='longuint64voidPtrThunk';fcns.name{fcnNum}='DAQmxGetWriteOverloadedChansExist'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'uint64', 'ulongPtr'};fcnNum=fcnNum+1;
% int32 __stdcall DAQmxGetWriteOverloadedChans ( TaskHandle taskHandle , char * data , uInt32 bufferSize ); 
fcns.thunkname{fcnNum}='longuint64cstringulongThunk';fcns.name{fcnNum}='DAQmxGetWriteOverloadedChans'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'uint64', 'cstring', 'ulong'};fcnNum=fcnNum+1;
