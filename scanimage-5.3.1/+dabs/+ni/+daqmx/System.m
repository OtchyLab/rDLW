classdef System < dabs.ni.daqmx.private.DAQmxClass
    ...
    methods 
        function obj = System(varargin)
            ...
            obj = dabs.ni.daqmx.System.getHandle();            
        end
    end
    ...
    methods
        ...
        function val = get.tasks(obj)
            val = dabs.ni.daqmx.Task.getAllTasks();            
        end
        
        function val = get.taskMap(obj)
            val = dabs.ni.daqmx.Task.getTaskMap();
        end
    ...
    methods (Static,Hidden)       
        function obj = getHandle()            
            ...
            if isempty(localObj) || ~isvalid(localObj)
                localObj = dabs.ni.daqmx.System('singleton');
            end
            obj = localObj;
        end        
    end    
