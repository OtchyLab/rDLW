    ...
    methods
        ...
        function set.zoomCtlDaq(obj, v)
            ...
            if tf
                ...
                obj.hResEnableTerminalPopUp.String = [{' '} obj.hConfigEditor.daqInfo(idx).pfi];
            else
