    ...
    methods
        function obj = RoiDisplay(hSI,parent,chan)
            ...
            obj.hSurfContextMenu = handle(uicontextmenu('Parent',obj.hFig,'Callback',@obj.contextMenuOpen));
                ...
                uimenu('Parent',obj.hSurfContextMenu,'Label','Correct Motion with Stage','Tag','uiMenuCorrectMotionWithStage','Callback',@(src,evt)obj.surfContextMenuCallback(@obj.correctMotionWithStage),'enable','off');
                ...
                uimenu('Parent',obj.hSurfContextMenu,'Label','Add to Scanfield Display window','enable','off');
                uimenu('Parent',obj.hSurfContextMenu,'Separator','on','Label','Set image as motion correction ref','enable','off');
                uimenu('Parent',obj.hSurfContextMenu,'Label','Enable motion correction','Tag','uiMenuMotionCorrectionEnabled','enable','off');
                uimenu('Parent',obj.hSurfContextMenu,'Label','Show motion','Tag','uiMenutoggleShowMotionCorrection','enable','off');
                uimenu('Parent',obj.hSurfContextMenu,'Label','Stabilize Display','Tag','uiMenuToggleStabilizeDisplay','enable','off');
            ...
            obj.hAxesContextMenu = handle(uicontextmenu('Parent',obj.hFig,'Callback',@obj.contextMenuOpen));
                ...
                uimenu('Parent',obj.hAxesContextMenu,'Separator','on','Label','Set vol as motion correction ref','enable','off');
                uimenu('Parent',obj.hAxesContextMenu,'Separator','on','Label','Enable motion correction','Tag','uiMenuMotionCorrectionEnabled','enable','off');
                uimenu('Parent',obj.hAxesContextMenu,'Label','Show motion','Tag','uiMenutoggleShowMotionCorrection','enable','off');
                uimenu('Parent',obj.hAxesContextMenu,'Label','Stabilize Display','Tag','uiMenuToggleStabilizeDisplay','enable','off');
    ...
    methods
        ...
        function scrollWheelFcn(obj,hAx,~,evt)
            ...
            if ~obj.is3dview
                ...
                maxCamAngle = atand(min(diff(hAx.XLim),diff(hAx.YLim))*maxViewPct / abs(hAx.CameraPosition(3)));
            ...
            if ~obj.is3dview
                ...
                viewportHalfSize = abs(obj.hAxes.CameraPosition(3)*tand(obj.hAxes.CameraViewAngle)) / 2;
                camPos =  obj.hAxes.CameraPosition;
                ...
                obj.hAxes.CameraPosition = camPos;
