classdef PDEPProp < most.DClass
    ...
    methods (Access=protected)
        ...
        function pdepPropGetDisallow(obj, src, evnt) %#ok<INUSD>
            propName = src.Name;
            most.idioms.dispError('Specified property (%s) cannot be accessed for objects of class %s\n', propName, class(obj));
        ...
        function pdepPropSetDisallow(obj, src, evnt) %#ok<INUSD>
            propName = src.Name;
            most.idioms.dispError('Specified property (%s) cannot be set for objects of class %s\n', propName, class(obj));
    ...
    methods (Hidden)
        ...
        function pdepPropHandleGetHidden(obj, src, evnt)
            ...
            if ~obj.pdepPropGlobalLock && ...
                ...
                try
                    ...
                    %most.idioms.dispError('WARNING(%s): Unable to access property ''%s'' because of following error:\n\t%s\n%s\n', class(obj), propName, ME.message, getLastErrorStack(ME));%TO091210A
        ...
        function pdepPropHandleSetHidden(obj, src, evnt)
            ...
            if ~obj.pdepPropGlobalLock && ...
                ...
                if ~tfErr
                    notify(obj,'pdepSetSuccess',most.PDEPPropEventData(propName));
                end
