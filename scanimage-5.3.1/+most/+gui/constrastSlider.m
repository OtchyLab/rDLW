classdef constrastSlider < handle
    ...
    methods
        function obj = constrastSlider(varargin)
            ...
            obj.hCar = patch('parent',obj.hAx,'xdata',[],'ydata',[],'zdata',[],'FaceColor',.5*ones(1,3),'LineWidth',0.5,'ButtonDownFcn',@obj.drag);
            obj.hCarL = patch('parent',obj.hAx,'xdata',[],'ydata',[],'zdata',[],'FaceColor',zeros(1,3),'LineWidth',1.5,'ButtonDownFcn',@obj.drag);
            obj.hCarH = patch('parent',obj.hAx,'xdata',[],'ydata',[],'zdata',[],'FaceColor',ones(1,3),'LineWidth',1.5,'ButtonDownFcn',@obj.drag);
    ...
    methods (Hidden)
        ...
        function drawCars(obj)
            if most.idioms.isValidObj(obj.hCar)
                ...
                % car
                xs = [v(1) v(2) v(2) v(1) v(1)];
                ys = [barHT barHT -barHT -barHT barHT];
                obj.hCar.XData = xs;
